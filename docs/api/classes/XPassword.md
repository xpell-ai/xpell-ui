[xpell-ui - v2.0.0-alpha.1](../README.md) / XPassword
...
- [constructor](XPassword.md#constructor)

### Properties

- [\_base\_display](XPassword.md#_base_display)
- [\_cache\_cmd\_txt](XPassword.md#_cache_cmd_txt)
- [\_cache\_jcmd](XPassword.md#_cache_jcmd)
- [\_children](XPassword.md#_children)
- [\_data\_source](XPassword.md#_data_source)
- [\_debug](XPassword.md#_debug)
- [\_dom\_object](XPassword.md#_dom_object)
- [\_event\_listeners\_ids](XPassword.md#_event_listeners_ids)
- [\_html](XPassword.md#_html)
- [\_html\_ns](XPassword.md#_html_ns)
- [\_html\_tag](XPassword.md#_html_tag)
- [\_id](XPassword.md#_id)
- [\_name](XPassword.md#_name)
- [\_nano\_commands](XPassword.md#_nano_commands)
- [\_on](XPassword.md#_on)
- [\_on\_click](XPassword.md#_on_click)
- [\_on\_create](XPassword.md#_on_create)
- [\_on\_data](XPassword.md#_on_data)
- [\_on\_event](XPassword.md#_on_event)
- [\_on\_frame](XPassword.md#_on_frame)
- [\_on\_hide](XPassword.md#_on_hide)
- [\_on\_hide\_animation](XPassword.md#_on_hide_animation)
- [\_on\_mount](XPassword.md#_on_mount)
- [\_on\_show](XPassword.md#_on_show)
- [\_on\_show\_animation](XPassword.md#_on_show_animation)
- [\_once](XPassword.md#_once)
- [\_parent](XPassword.md#_parent)
- [\_parent\_element](XPassword.md#_parent_element)
- [\_process\_data](XPassword.md#_process_data)
- [\_process\_frame](XPassword.md#_process_frame)
- [\_type](XPassword.md#_type)
- [\_visible](XPassword.md#_visible)
- [\_xem\_options](XPassword.md#_xem_options)
- [\_xporter](XPassword.md#_xporter)
- [\_xtype](XPassword.md#_xtype)
- [type](XPassword.md#type)

### Accessors

- [\_text](XPassword.md#_text)
- [dom](XPassword.md#dom)

### Methods

- [addChild](XPassword.md#addchild)
- [addClass](XPassword.md#addclass)
- [addEventListener](XPassword.md#addeventlistener)
- [addNanoCommand](XPassword.md#addnanocommand)
- [addNanoCommandPack](XPassword.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XPassword.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XPassword.md#addxporterinstancexporter)
- [animate](XPassword.md#animate)
- [append](XPassword.md#append)
- [attach](XPassword.md#attach)
- [checkAndRunInternalFunction](XPassword.md#checkandruninternalfunction)
- [clearAttributes](XPassword.md#clearattributes)
- [click](XPassword.md#click)
- [dispose](XPassword.md#dispose)
- [emptyDataSource](XPassword.md#emptydatasource)
- [execute](XPassword.md#execute)
- [getDOMObject](XPassword.md#getdomobject)
- [getHTML](XPassword.md#gethtml)
- [hide](XPassword.md#hide)
- [init](XPassword.md#init)
- [log](XPassword.md#log)
- [mount](XPassword.md#mount)
- [onCreate](XPassword.md#oncreate)
- [onData](XPassword.md#ondata)
- [onFrame](XPassword.md#onframe)
- [onHide](XPassword.md#onhide)
- [onMount](XPassword.md#onmount)
- [onShow](XPassword.md#onshow)
- [parse](XPassword.md#parse)
- [parseEvents](XPassword.md#parseevents)
- [parseFields](XPassword.md#parsefields)
- [parseFieldsFromXDataObject](XPassword.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XPassword.md#removealleventlisteners)
- [removeChild](XPassword.md#removechild)
- [removeClass](XPassword.md#removeclass)
- [removeEventListener](XPassword.md#removeeventlistener)
- [replaceClass](XPassword.md#replaceclass)
- [run](XPassword.md#run)
- [setStyleAttribute](XPassword.md#setstyleattribute)
- [setText](XPassword.md#settext)
- [show](XPassword.md#show)
- [stopAnimation](XPassword.md#stopanimation)
- [toString](XPassword.md#tostring)
- [toXData](XPassword.md#toxdata)
- [toggle](XPassword.md#toggle)
- [toggleClass](XPassword.md#toggleclass)

## Constructors

### constructor

• **new XPassword**(`data`): [`XPassword`](XPassword.md)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:190](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L190)
...
▪ `Static` **\_xtype**: `string` = `"password"`

#### Defined in

[web/xpell-ui/src/XUI/XUICoreObjects.ts:188](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L188)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:189](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L189)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:207](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L207)
