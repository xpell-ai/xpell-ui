[xpell-ui - v2.0.0-alpha.1](../README.md) / XHeader
...
- [constructor](XHeader.md#constructor)

### Properties

- [\_base\_display](XHeader.md#_base_display)
- [\_cache\_cmd\_txt](XHeader.md#_cache_cmd_txt)
- [\_cache\_jcmd](XHeader.md#_cache_jcmd)
- [\_children](XHeader.md#_children)
- [\_data\_source](XHeader.md#_data_source)
- [\_debug](XHeader.md#_debug)
- [\_dom\_object](XHeader.md#_dom_object)
- [\_event\_listeners\_ids](XHeader.md#_event_listeners_ids)
- [\_html](XHeader.md#_html)
- [\_html\_ns](XHeader.md#_html_ns)
- [\_html\_tag](XHeader.md#_html_tag)
- [\_id](XHeader.md#_id)
- [\_name](XHeader.md#_name)
- [\_nano\_commands](XHeader.md#_nano_commands)
- [\_on](XHeader.md#_on)
- [\_on\_click](XHeader.md#_on_click)
- [\_on\_create](XHeader.md#_on_create)
- [\_on\_data](XHeader.md#_on_data)
- [\_on\_event](XHeader.md#_on_event)
- [\_on\_frame](XHeader.md#_on_frame)
- [\_on\_hide](XHeader.md#_on_hide)
- [\_on\_hide\_animation](XHeader.md#_on_hide_animation)
- [\_on\_mount](XHeader.md#_on_mount)
- [\_on\_show](XHeader.md#_on_show)
- [\_on\_show\_animation](XHeader.md#_on_show_animation)
- [\_once](XHeader.md#_once)
- [\_parent](XHeader.md#_parent)
- [\_parent\_element](XHeader.md#_parent_element)
- [\_process\_data](XHeader.md#_process_data)
- [\_process\_frame](XHeader.md#_process_frame)
- [\_type](XHeader.md#_type)
- [\_visible](XHeader.md#_visible)
- [\_xem\_options](XHeader.md#_xem_options)
- [\_xporter](XHeader.md#_xporter)
- [\_xtype](XHeader.md#_xtype)

### Accessors

- [\_text](XHeader.md#_text)
- [dom](XHeader.md#dom)

### Methods

- [addChild](XHeader.md#addchild)
- [addClass](XHeader.md#addclass)
- [addEventListener](XHeader.md#addeventlistener)
- [addNanoCommand](XHeader.md#addnanocommand)
- [addNanoCommandPack](XHeader.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XHeader.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XHeader.md#addxporterinstancexporter)
- [animate](XHeader.md#animate)
- [append](XHeader.md#append)
- [attach](XHeader.md#attach)
- [checkAndRunInternalFunction](XHeader.md#checkandruninternalfunction)
- [clearAttributes](XHeader.md#clearattributes)
- [click](XHeader.md#click)
- [dispose](XHeader.md#dispose)
- [emptyDataSource](XHeader.md#emptydatasource)
- [execute](XHeader.md#execute)
- [getDOMObject](XHeader.md#getdomobject)
- [getHTML](XHeader.md#gethtml)
- [hide](XHeader.md#hide)
- [init](XHeader.md#init)
- [log](XHeader.md#log)
- [mount](XHeader.md#mount)
- [onCreate](XHeader.md#oncreate)
- [onData](XHeader.md#ondata)
- [onFrame](XHeader.md#onframe)
- [onHide](XHeader.md#onhide)
- [onMount](XHeader.md#onmount)
- [onShow](XHeader.md#onshow)
- [parse](XHeader.md#parse)
- [parseEvents](XHeader.md#parseevents)
- [parseFields](XHeader.md#parsefields)
- [parseFieldsFromXDataObject](XHeader.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XHeader.md#removealleventlisteners)
- [removeChild](XHeader.md#removechild)
- [removeClass](XHeader.md#removeclass)
- [removeEventListener](XHeader.md#removeeventlistener)
- [replaceClass](XHeader.md#replaceclass)
- [run](XHeader.md#run)
- [setStyleAttribute](XHeader.md#setstyleattribute)
- [setText](XHeader.md#settext)
- [show](XHeader.md#show)
- [stopAnimation](XHeader.md#stopanimation)
- [toString](XHeader.md#tostring)
- [toXData](XHeader.md#toxdata)
- [toggle](XHeader.md#toggle)
- [toggleClass](XHeader.md#toggleclass)

## Constructors

### constructor

• **new XHeader**(`data`): [`XHeader`](XHeader.md)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:30](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L30)
...
▪ `Static` **\_xtype**: `string` = `"header"`

#### Defined in

[web/xpell-ui/src/XUI/XUICoreObjects.ts:29](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L29)
