[xpell-ui - v2.0.0-alpha.1](../README.md) / XSVGPolyline
...
- [constructor](XSVGPolyline.md#constructor)

### Properties

- [\_base\_display](XSVGPolyline.md#_base_display)
- [\_cache\_cmd\_txt](XSVGPolyline.md#_cache_cmd_txt)
- [\_cache\_jcmd](XSVGPolyline.md#_cache_jcmd)
- [\_children](XSVGPolyline.md#_children)
- [\_data\_source](XSVGPolyline.md#_data_source)
- [\_debug](XSVGPolyline.md#_debug)
- [\_dom\_object](XSVGPolyline.md#_dom_object)
- [\_event\_listeners\_ids](XSVGPolyline.md#_event_listeners_ids)
- [\_html](XSVGPolyline.md#_html)
- [\_html\_ns](XSVGPolyline.md#_html_ns)
- [\_html\_tag](XSVGPolyline.md#_html_tag)
- [\_id](XSVGPolyline.md#_id)
- [\_name](XSVGPolyline.md#_name)
- [\_nano\_commands](XSVGPolyline.md#_nano_commands)
- [\_on](XSVGPolyline.md#_on)
- [\_on\_click](XSVGPolyline.md#_on_click)
- [\_on\_create](XSVGPolyline.md#_on_create)
- [\_on\_data](XSVGPolyline.md#_on_data)
- [\_on\_event](XSVGPolyline.md#_on_event)
- [\_on\_frame](XSVGPolyline.md#_on_frame)
- [\_on\_hide](XSVGPolyline.md#_on_hide)
- [\_on\_hide\_animation](XSVGPolyline.md#_on_hide_animation)
- [\_on\_mount](XSVGPolyline.md#_on_mount)
- [\_on\_show](XSVGPolyline.md#_on_show)
- [\_on\_show\_animation](XSVGPolyline.md#_on_show_animation)
- [\_once](XSVGPolyline.md#_once)
- [\_parent](XSVGPolyline.md#_parent)
- [\_parent\_element](XSVGPolyline.md#_parent_element)
- [\_process\_data](XSVGPolyline.md#_process_data)
- [\_process\_frame](XSVGPolyline.md#_process_frame)
- [\_type](XSVGPolyline.md#_type)
- [\_visible](XSVGPolyline.md#_visible)
- [\_xem\_options](XSVGPolyline.md#_xem_options)
- [\_xporter](XSVGPolyline.md#_xporter)
- [\_xtype](XSVGPolyline.md#_xtype)

### Accessors

- [\_text](XSVGPolyline.md#_text)
- [dom](XSVGPolyline.md#dom)

### Methods

- [addChild](XSVGPolyline.md#addchild)
- [addClass](XSVGPolyline.md#addclass)
- [addEventListener](XSVGPolyline.md#addeventlistener)
- [addNanoCommand](XSVGPolyline.md#addnanocommand)
- [addNanoCommandPack](XSVGPolyline.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XSVGPolyline.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XSVGPolyline.md#addxporterinstancexporter)
- [animate](XSVGPolyline.md#animate)
- [append](XSVGPolyline.md#append)
- [attach](XSVGPolyline.md#attach)
- [checkAndRunInternalFunction](XSVGPolyline.md#checkandruninternalfunction)
- [clearAttributes](XSVGPolyline.md#clearattributes)
- [click](XSVGPolyline.md#click)
- [dispose](XSVGPolyline.md#dispose)
- [emptyDataSource](XSVGPolyline.md#emptydatasource)
- [execute](XSVGPolyline.md#execute)
- [getDOMObject](XSVGPolyline.md#getdomobject)
- [getHTML](XSVGPolyline.md#gethtml)
- [hide](XSVGPolyline.md#hide)
- [init](XSVGPolyline.md#init)
- [log](XSVGPolyline.md#log)
- [mount](XSVGPolyline.md#mount)
- [onCreate](XSVGPolyline.md#oncreate)
- [onData](XSVGPolyline.md#ondata)
- [onFrame](XSVGPolyline.md#onframe)
- [onHide](XSVGPolyline.md#onhide)
- [onMount](XSVGPolyline.md#onmount)
- [onShow](XSVGPolyline.md#onshow)
- [parse](XSVGPolyline.md#parse)
- [parseEvents](XSVGPolyline.md#parseevents)
- [parseFields](XSVGPolyline.md#parsefields)
- [parseFieldsFromXDataObject](XSVGPolyline.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XSVGPolyline.md#removealleventlisteners)
- [removeChild](XSVGPolyline.md#removechild)
- [removeClass](XSVGPolyline.md#removeclass)
- [removeEventListener](XSVGPolyline.md#removeeventlistener)
- [replaceClass](XSVGPolyline.md#replaceclass)
- [run](XSVGPolyline.md#run)
- [setStyleAttribute](XSVGPolyline.md#setstyleattribute)
- [setText](XSVGPolyline.md#settext)
- [show](XSVGPolyline.md#show)
- [stopAnimation](XSVGPolyline.md#stopanimation)
- [toString](XSVGPolyline.md#tostring)
- [toXData](XSVGPolyline.md#toxdata)
- [toggle](XSVGPolyline.md#toggle)
- [toggleClass](XSVGPolyline.md#toggleclass)

## Constructors

### constructor

• **new XSVGPolyline**(`data`): [`XSVGPolyline`](XSVGPolyline.md)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:559](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L559)
...
▪ `Static` **\_xtype**: `string` = `"polyline"`

#### Defined in

[web/xpell-ui/src/XUI/XUICoreObjects.ts:557](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L557)
