[xpell-ui - v2.0.0-alpha.1](../README.md) / XWebcam
...
- [constructor](XWebcam.md#constructor)

### Properties

- [\_base\_display](XWebcam.md#_base_display)
- [\_cache\_cmd\_txt](XWebcam.md#_cache_cmd_txt)
- [\_cache\_jcmd](XWebcam.md#_cache_jcmd)
- [\_children](XWebcam.md#_children)
- [\_data\_source](XWebcam.md#_data_source)
- [\_debug](XWebcam.md#_debug)
- [\_dom\_object](XWebcam.md#_dom_object)
- [\_event\_listeners\_ids](XWebcam.md#_event_listeners_ids)
- [\_html](XWebcam.md#_html)
- [\_html\_ns](XWebcam.md#_html_ns)
- [\_html\_tag](XWebcam.md#_html_tag)
- [\_id](XWebcam.md#_id)
- [\_name](XWebcam.md#_name)
- [\_nano\_commands](XWebcam.md#_nano_commands)
- [\_on](XWebcam.md#_on)
- [\_on\_click](XWebcam.md#_on_click)
- [\_on\_create](XWebcam.md#_on_create)
- [\_on\_data](XWebcam.md#_on_data)
- [\_on\_event](XWebcam.md#_on_event)
- [\_on\_frame](XWebcam.md#_on_frame)
- [\_on\_hide](XWebcam.md#_on_hide)
- [\_on\_hide\_animation](XWebcam.md#_on_hide_animation)
- [\_on\_mount](XWebcam.md#_on_mount)
- [\_on\_show](XWebcam.md#_on_show)
- [\_on\_show\_animation](XWebcam.md#_on_show_animation)
- [\_once](XWebcam.md#_once)
- [\_parent](XWebcam.md#_parent)
- [\_parent\_element](XWebcam.md#_parent_element)
- [\_process\_data](XWebcam.md#_process_data)
- [\_process\_frame](XWebcam.md#_process_frame)
- [\_type](XWebcam.md#_type)
- [\_video\_constraints](XWebcam.md#_video_constraints)
- [\_visible](XWebcam.md#_visible)
- [\_xem\_options](XWebcam.md#_xem_options)
- [\_xporter](XWebcam.md#_xporter)
- [\_xtype](XWebcam.md#_xtype)
- [autoplay](XWebcam.md#autoplay)
- [muted](XWebcam.md#muted)

### Accessors

- [\_text](XWebcam.md#_text)
- [dom](XWebcam.md#dom)
- [isPlaying](XWebcam.md#isplaying)

### Methods

- [addChild](XWebcam.md#addchild)
- [addClass](XWebcam.md#addclass)
- [addEventListener](XWebcam.md#addeventlistener)
- [addNanoCommand](XWebcam.md#addnanocommand)
- [addNanoCommandPack](XWebcam.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XWebcam.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XWebcam.md#addxporterinstancexporter)
- [animate](XWebcam.md#animate)
- [append](XWebcam.md#append)
- [attach](XWebcam.md#attach)
- [checkAndRunInternalFunction](XWebcam.md#checkandruninternalfunction)
- [clearAttributes](XWebcam.md#clearattributes)
- [click](XWebcam.md#click)
- [dispose](XWebcam.md#dispose)
- [emptyDataSource](XWebcam.md#emptydatasource)
- [execute](XWebcam.md#execute)
- [getDOMObject](XWebcam.md#getdomobject)
- [getHTML](XWebcam.md#gethtml)
- [hide](XWebcam.md#hide)
- [init](XWebcam.md#init)
- [isAvailable](XWebcam.md#isavailable)
- [log](XWebcam.md#log)
- [mount](XWebcam.md#mount)
- [onCreate](XWebcam.md#oncreate)
- [onData](XWebcam.md#ondata)
- [onFrame](XWebcam.md#onframe)
- [onHide](XWebcam.md#onhide)
- [onMount](XWebcam.md#onmount)
- [onShow](XWebcam.md#onshow)
- [parse](XWebcam.md#parse)
- [parseEvents](XWebcam.md#parseevents)
- [parseFields](XWebcam.md#parsefields)
- [parseFieldsFromXDataObject](XWebcam.md#parsefieldsfromxdataobject)
- [pause](XWebcam.md#pause)
- [removeAllEventListeners](XWebcam.md#removealleventlisteners)
- [removeChild](XWebcam.md#removechild)
- [removeClass](XWebcam.md#removeclass)
- [removeEventListener](XWebcam.md#removeeventlistener)
- [replaceClass](XWebcam.md#replaceclass)
- [run](XWebcam.md#run)
- [setSource](XWebcam.md#setsource)
- [setStyleAttribute](XWebcam.md#setstyleattribute)
- [setText](XWebcam.md#settext)
- [show](XWebcam.md#show)
- [stopAnimation](XWebcam.md#stopanimation)
- [toString](XWebcam.md#tostring)
- [toXData](XWebcam.md#toxdata)
- [toggle](XWebcam.md#toggle)
- [toggleClass](XWebcam.md#toggleclass)

## Constructors

### constructor

• **new XWebcam**(`data`): [`XWebcam`](XWebcam.md)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:106](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L106)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:104](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L104)
...
▪ `Static` **\_xtype**: `string` = `"webcam"`

#### Defined in

[web/xpell-ui/src/XUI/XUICoreObjects.ts:101](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L101)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:102](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L102)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:103](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L103)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:149](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L149)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:129](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L129)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:154](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L154)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:133](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L133)
