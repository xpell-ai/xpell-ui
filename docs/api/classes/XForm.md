[xpell-ui - v2.0.0-alpha.1](../README.md) / XForm
...
- [constructor](XForm.md#constructor)

### Properties

- [\_base\_display](XForm.md#_base_display)
- [\_cache\_cmd\_txt](XForm.md#_cache_cmd_txt)
- [\_cache\_jcmd](XForm.md#_cache_jcmd)
- [\_children](XForm.md#_children)
- [\_data\_source](XForm.md#_data_source)
- [\_debug](XForm.md#_debug)
- [\_dom\_object](XForm.md#_dom_object)
- [\_event\_listeners\_ids](XForm.md#_event_listeners_ids)
- [\_html](XForm.md#_html)
- [\_html\_ns](XForm.md#_html_ns)
- [\_html\_tag](XForm.md#_html_tag)
- [\_id](XForm.md#_id)
- [\_name](XForm.md#_name)
- [\_nano\_commands](XForm.md#_nano_commands)
- [\_on](XForm.md#_on)
- [\_on\_click](XForm.md#_on_click)
- [\_on\_create](XForm.md#_on_create)
- [\_on\_data](XForm.md#_on_data)
- [\_on\_event](XForm.md#_on_event)
- [\_on\_frame](XForm.md#_on_frame)
- [\_on\_hide](XForm.md#_on_hide)
- [\_on\_hide\_animation](XForm.md#_on_hide_animation)
- [\_on\_mount](XForm.md#_on_mount)
- [\_on\_show](XForm.md#_on_show)
- [\_on\_show\_animation](XForm.md#_on_show_animation)
- [\_once](XForm.md#_once)
- [\_parent](XForm.md#_parent)
- [\_parent\_element](XForm.md#_parent_element)
- [\_process\_data](XForm.md#_process_data)
- [\_process\_frame](XForm.md#_process_frame)
- [\_type](XForm.md#_type)
- [\_visible](XForm.md#_visible)
- [\_xem\_options](XForm.md#_xem_options)
- [\_xporter](XForm.md#_xporter)
- [\_xtype](XForm.md#_xtype)

### Accessors

- [\_text](XForm.md#_text)
- [dom](XForm.md#dom)

### Methods

- [addChild](XForm.md#addchild)
- [addClass](XForm.md#addclass)
- [addEventListener](XForm.md#addeventlistener)
- [addNanoCommand](XForm.md#addnanocommand)
- [addNanoCommandPack](XForm.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XForm.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XForm.md#addxporterinstancexporter)
- [animate](XForm.md#animate)
- [append](XForm.md#append)
- [attach](XForm.md#attach)
- [checkAndRunInternalFunction](XForm.md#checkandruninternalfunction)
- [clearAttributes](XForm.md#clearattributes)
- [click](XForm.md#click)
- [dispose](XForm.md#dispose)
- [emptyDataSource](XForm.md#emptydatasource)
- [execute](XForm.md#execute)
- [getDOMObject](XForm.md#getdomobject)
- [getHTML](XForm.md#gethtml)
- [hide](XForm.md#hide)
- [init](XForm.md#init)
- [log](XForm.md#log)
- [mount](XForm.md#mount)
- [onCreate](XForm.md#oncreate)
- [onData](XForm.md#ondata)
- [onFrame](XForm.md#onframe)
- [onHide](XForm.md#onhide)
- [onMount](XForm.md#onmount)
- [onShow](XForm.md#onshow)
- [parse](XForm.md#parse)
- [parseEvents](XForm.md#parseevents)
- [parseFields](XForm.md#parsefields)
- [parseFieldsFromXDataObject](XForm.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XForm.md#removealleventlisteners)
- [removeChild](XForm.md#removechild)
- [removeClass](XForm.md#removeclass)
- [removeEventListener](XForm.md#removeeventlistener)
- [replaceClass](XForm.md#replaceclass)
- [run](XForm.md#run)
- [setStyleAttribute](XForm.md#setstyleattribute)
- [setText](XForm.md#settext)
- [show](XForm.md#show)
- [stopAnimation](XForm.md#stopanimation)
- [toString](XForm.md#tostring)
- [toXData](XForm.md#toxdata)
- [toggle](XForm.md#toggle)
- [toggleClass](XForm.md#toggleclass)

## Constructors

### constructor

• **new XForm**(`data`): [`XForm`](XForm.md)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:57](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L57)
...
▪ `Static` **\_xtype**: `string` = `"form"`

#### Defined in

[web/xpell-ui/src/XUI/XUICoreObjects.ts:56](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L56)
