[xpell-ui - v2.0.0-alpha.1](../README.md) / XSVG
...
- [constructor](XSVG.md#constructor)

### Properties

- [\_base\_display](XSVG.md#_base_display)
- [\_cache\_cmd\_txt](XSVG.md#_cache_cmd_txt)
- [\_cache\_jcmd](XSVG.md#_cache_jcmd)
- [\_children](XSVG.md#_children)
- [\_data\_source](XSVG.md#_data_source)
- [\_debug](XSVG.md#_debug)
- [\_dom\_object](XSVG.md#_dom_object)
- [\_event\_listeners\_ids](XSVG.md#_event_listeners_ids)
- [\_html](XSVG.md#_html)
- [\_html\_ns](XSVG.md#_html_ns)
- [\_html\_tag](XSVG.md#_html_tag)
- [\_id](XSVG.md#_id)
- [\_name](XSVG.md#_name)
- [\_nano\_commands](XSVG.md#_nano_commands)
- [\_on](XSVG.md#_on)
- [\_on\_click](XSVG.md#_on_click)
- [\_on\_create](XSVG.md#_on_create)
- [\_on\_data](XSVG.md#_on_data)
- [\_on\_event](XSVG.md#_on_event)
- [\_on\_frame](XSVG.md#_on_frame)
- [\_on\_hide](XSVG.md#_on_hide)
- [\_on\_hide\_animation](XSVG.md#_on_hide_animation)
- [\_on\_mount](XSVG.md#_on_mount)
- [\_on\_show](XSVG.md#_on_show)
- [\_on\_show\_animation](XSVG.md#_on_show_animation)
- [\_once](XSVG.md#_once)
- [\_parent](XSVG.md#_parent)
- [\_parent\_element](XSVG.md#_parent_element)
- [\_process\_data](XSVG.md#_process_data)
- [\_process\_frame](XSVG.md#_process_frame)
- [\_type](XSVG.md#_type)
- [\_url](XSVG.md#_url)
- [\_visible](XSVG.md#_visible)
- [\_xem\_options](XSVG.md#_xem_options)
- [\_xporter](XSVG.md#_xporter)
- [\_xtype](XSVG.md#_xtype)
- [src](XSVG.md#src)
...
- [addChild](XSVG.md#addchild)
- [addClass](XSVG.md#addclass)
- [addEventListener](XSVG.md#addeventlistener)
- [addNanoCommand](XSVG.md#addnanocommand)
- [addNanoCommandPack](XSVG.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XSVG.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XSVG.md#addxporterinstancexporter)
- [animate](XSVG.md#animate)
- [append](XSVG.md#append)
- [attach](XSVG.md#attach)
- [checkAndRunInternalFunction](XSVG.md#checkandruninternalfunction)
- [clearAttributes](XSVG.md#clearattributes)
- [click](XSVG.md#click)
- [dispose](XSVG.md#dispose)
- [emptyDataSource](XSVG.md#emptydatasource)
- [execute](XSVG.md#execute)
- [getDOMObject](XSVG.md#getdomobject)
- [getFromData](XSVG.md#getfromdata)
- [getFromUrl](XSVG.md#getfromurl)
- [getHTML](XSVG.md#gethtml)
- [getSVGData](XSVG.md#getsvgdata)
- [hide](XSVG.md#hide)
- [init](XSVG.md#init)
- [log](XSVG.md#log)
- [mount](XSVG.md#mount)
- [onCreate](XSVG.md#oncreate)
- [onData](XSVG.md#ondata)
- [onFrame](XSVG.md#onframe)
- [onHide](XSVG.md#onhide)
- [onMount](XSVG.md#onmount)
- [onShow](XSVG.md#onshow)
- [parse](XSVG.md#parse)
- [parseEvents](XSVG.md#parseevents)
- [parseFields](XSVG.md#parsefields)
- [parseFieldsFromXDataObject](XSVG.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XSVG.md#removealleventlisteners)
- [removeChild](XSVG.md#removechild)
- [removeClass](XSVG.md#removeclass)
- [removeEventListener](XSVG.md#removeeventlistener)
- [replaceClass](XSVG.md#replaceclass)
- [run](XSVG.md#run)
- [setStyleAttribute](XSVG.md#setstyleattribute)
- [setText](XSVG.md#settext)
- [show](XSVG.md#show)
- [stopAnimation](XSVG.md#stopanimation)
- [toString](XSVG.md#tostring)
- [toXData](XSVG.md#toxdata)
- [toggle](XSVG.md#toggle)
- [toggleClass](XSVG.md#toggleclass)

## Constructors

### constructor

• **new XSVG**(`data`): [`XSVG`](XSVG.md)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:375](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L375)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:372](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L372)
...
▪ `Static` **\_xtype**: `string` = `"svg"`

#### Defined in

[web/xpell-ui/src/XUI/XUICoreObjects.ts:368](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L368)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:373](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L373)
...
▸ **animate**(`className?`): `Promise`\<`void`\>

#### Parameters

| Name | Type | Default value |
| :------ | :------ | :------ |
| `className` | `string` | `"fillPulse"` |
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:401](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L401)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:471](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L471)

___

### getFromUrl

▸ **getFromUrl**(`url`): `Promise`\<`void`\>
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:454](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L454)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:481](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L481)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:391](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L391)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:416](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L416)
