[xpell-ui - v2.0.0-alpha.1](../README.md) / XLink
...
- [constructor](XLink.md#constructor)

### Properties

- [\_base\_display](XLink.md#_base_display)
- [\_cache\_cmd\_txt](XLink.md#_cache_cmd_txt)
- [\_cache\_jcmd](XLink.md#_cache_jcmd)
- [\_children](XLink.md#_children)
- [\_data\_source](XLink.md#_data_source)
- [\_debug](XLink.md#_debug)
- [\_dom\_object](XLink.md#_dom_object)
- [\_event\_listeners\_ids](XLink.md#_event_listeners_ids)
- [\_html](XLink.md#_html)
- [\_html\_ns](XLink.md#_html_ns)
- [\_html\_tag](XLink.md#_html_tag)
- [\_id](XLink.md#_id)
- [\_name](XLink.md#_name)
- [\_nano\_commands](XLink.md#_nano_commands)
- [\_on](XLink.md#_on)
- [\_on\_click](XLink.md#_on_click)
- [\_on\_create](XLink.md#_on_create)
- [\_on\_data](XLink.md#_on_data)
- [\_on\_event](XLink.md#_on_event)
- [\_on\_frame](XLink.md#_on_frame)
- [\_on\_hide](XLink.md#_on_hide)
- [\_on\_hide\_animation](XLink.md#_on_hide_animation)
- [\_on\_mount](XLink.md#_on_mount)
- [\_on\_show](XLink.md#_on_show)
- [\_on\_show\_animation](XLink.md#_on_show_animation)
- [\_once](XLink.md#_once)
- [\_parent](XLink.md#_parent)
- [\_parent\_element](XLink.md#_parent_element)
- [\_process\_data](XLink.md#_process_data)
- [\_process\_frame](XLink.md#_process_frame)
- [\_type](XLink.md#_type)
- [\_visible](XLink.md#_visible)
- [\_xem\_options](XLink.md#_xem_options)
- [\_xporter](XLink.md#_xporter)
- [\_xtype](XLink.md#_xtype)

### Accessors

- [\_text](XLink.md#_text)
- [dom](XLink.md#dom)

### Methods

- [addChild](XLink.md#addchild)
- [addClass](XLink.md#addclass)
- [addEventListener](XLink.md#addeventlistener)
- [addNanoCommand](XLink.md#addnanocommand)
- [addNanoCommandPack](XLink.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XLink.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XLink.md#addxporterinstancexporter)
- [animate](XLink.md#animate)
- [append](XLink.md#append)
- [attach](XLink.md#attach)
- [checkAndRunInternalFunction](XLink.md#checkandruninternalfunction)
- [clearAttributes](XLink.md#clearattributes)
- [click](XLink.md#click)
- [dispose](XLink.md#dispose)
- [emptyDataSource](XLink.md#emptydatasource)
- [execute](XLink.md#execute)
- [getDOMObject](XLink.md#getdomobject)
- [getHTML](XLink.md#gethtml)
- [hide](XLink.md#hide)
- [init](XLink.md#init)
- [log](XLink.md#log)
- [mount](XLink.md#mount)
- [onCreate](XLink.md#oncreate)
- [onData](XLink.md#ondata)
- [onFrame](XLink.md#onframe)
- [onHide](XLink.md#onhide)
- [onMount](XLink.md#onmount)
- [onShow](XLink.md#onshow)
- [parse](XLink.md#parse)
- [parseEvents](XLink.md#parseevents)
- [parseFields](XLink.md#parsefields)
- [parseFieldsFromXDataObject](XLink.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XLink.md#removealleventlisteners)
- [removeChild](XLink.md#removechild)
- [removeClass](XLink.md#removeclass)
- [removeEventListener](XLink.md#removeeventlistener)
- [replaceClass](XLink.md#replaceclass)
- [run](XLink.md#run)
- [setStyleAttribute](XLink.md#setstyleattribute)
- [setText](XLink.md#settext)
- [show](XLink.md#show)
- [stopAnimation](XLink.md#stopanimation)
- [toString](XLink.md#tostring)
- [toXData](XLink.md#toxdata)
- [toggle](XLink.md#toggle)
- [toggleClass](XLink.md#toggleclass)

## Constructors

### constructor

• **new XLink**(`data`): [`XLink`](XLink.md)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:281](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L281)
...
▪ `Static` **\_xtype**: `string` = `"link"`

#### Defined in

[web/xpell-ui/src/XUI/XUICoreObjects.ts:279](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L279)
