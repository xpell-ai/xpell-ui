[xpell-ui - v2.0.0-alpha.1](../README.md) / XSVGPath
...
- [constructor](XSVGPath.md#constructor)

### Properties

- [\_base\_display](XSVGPath.md#_base_display)
- [\_cache\_cmd\_txt](XSVGPath.md#_cache_cmd_txt)
- [\_cache\_jcmd](XSVGPath.md#_cache_jcmd)
- [\_children](XSVGPath.md#_children)
- [\_data\_source](XSVGPath.md#_data_source)
- [\_debug](XSVGPath.md#_debug)
- [\_dom\_object](XSVGPath.md#_dom_object)
- [\_event\_listeners\_ids](XSVGPath.md#_event_listeners_ids)
- [\_html](XSVGPath.md#_html)
- [\_html\_ns](XSVGPath.md#_html_ns)
- [\_html\_tag](XSVGPath.md#_html_tag)
- [\_id](XSVGPath.md#_id)
- [\_name](XSVGPath.md#_name)
- [\_nano\_commands](XSVGPath.md#_nano_commands)
- [\_on](XSVGPath.md#_on)
- [\_on\_click](XSVGPath.md#_on_click)
- [\_on\_create](XSVGPath.md#_on_create)
- [\_on\_data](XSVGPath.md#_on_data)
- [\_on\_event](XSVGPath.md#_on_event)
- [\_on\_frame](XSVGPath.md#_on_frame)
- [\_on\_hide](XSVGPath.md#_on_hide)
- [\_on\_hide\_animation](XSVGPath.md#_on_hide_animation)
- [\_on\_mount](XSVGPath.md#_on_mount)
- [\_on\_show](XSVGPath.md#_on_show)
- [\_on\_show\_animation](XSVGPath.md#_on_show_animation)
- [\_once](XSVGPath.md#_once)
- [\_parent](XSVGPath.md#_parent)
- [\_parent\_element](XSVGPath.md#_parent_element)
- [\_process\_data](XSVGPath.md#_process_data)
- [\_process\_frame](XSVGPath.md#_process_frame)
- [\_type](XSVGPath.md#_type)
- [\_visible](XSVGPath.md#_visible)
- [\_xem\_options](XSVGPath.md#_xem_options)
- [\_xporter](XSVGPath.md#_xporter)
- [\_xtype](XSVGPath.md#_xtype)

### Accessors

- [\_text](XSVGPath.md#_text)
- [dom](XSVGPath.md#dom)

### Methods

- [addChild](XSVGPath.md#addchild)
- [addClass](XSVGPath.md#addclass)
- [addEventListener](XSVGPath.md#addeventlistener)
- [addNanoCommand](XSVGPath.md#addnanocommand)
- [addNanoCommandPack](XSVGPath.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XSVGPath.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XSVGPath.md#addxporterinstancexporter)
- [animate](XSVGPath.md#animate)
- [append](XSVGPath.md#append)
- [attach](XSVGPath.md#attach)
- [checkAndRunInternalFunction](XSVGPath.md#checkandruninternalfunction)
- [clearAttributes](XSVGPath.md#clearattributes)
- [click](XSVGPath.md#click)
- [dispose](XSVGPath.md#dispose)
- [emptyDataSource](XSVGPath.md#emptydatasource)
- [execute](XSVGPath.md#execute)
- [getDOMObject](XSVGPath.md#getdomobject)
- [getHTML](XSVGPath.md#gethtml)
- [hide](XSVGPath.md#hide)
- [init](XSVGPath.md#init)
- [log](XSVGPath.md#log)
- [mount](XSVGPath.md#mount)
- [onCreate](XSVGPath.md#oncreate)
- [onData](XSVGPath.md#ondata)
- [onFrame](XSVGPath.md#onframe)
- [onHide](XSVGPath.md#onhide)
- [onMount](XSVGPath.md#onmount)
- [onShow](XSVGPath.md#onshow)
- [parse](XSVGPath.md#parse)
- [parseEvents](XSVGPath.md#parseevents)
- [parseFields](XSVGPath.md#parsefields)
- [parseFieldsFromXDataObject](XSVGPath.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XSVGPath.md#removealleventlisteners)
- [removeChild](XSVGPath.md#removechild)
- [removeClass](XSVGPath.md#removeclass)
- [removeEventListener](XSVGPath.md#removeeventlistener)
- [replaceClass](XSVGPath.md#replaceclass)
- [run](XSVGPath.md#run)
- [setStyleAttribute](XSVGPath.md#setstyleattribute)
- [setText](XSVGPath.md#settext)
- [show](XSVGPath.md#show)
- [stopAnimation](XSVGPath.md#stopanimation)
- [toString](XSVGPath.md#tostring)
- [toXData](XSVGPath.md#toxdata)
- [toggle](XSVGPath.md#toggle)
- [toggleClass](XSVGPath.md#toggleclass)

## Constructors

### constructor

• **new XSVGPath**(`data`): [`XSVGPath`](XSVGPath.md)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:591](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L591)
...
▪ `Static` **\_xtype**: `string` = `"path"`

#### Defined in

[web/xpell-ui/src/XUI/XUICoreObjects.ts:589](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L589)
