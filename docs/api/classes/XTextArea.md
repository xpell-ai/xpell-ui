[xpell-ui - v2.0.0-alpha.1](../README.md) / XTextArea
...
- [constructor](XTextArea.md#constructor)

### Properties

- [\_base\_display](XTextArea.md#_base_display)
- [\_cache\_cmd\_txt](XTextArea.md#_cache_cmd_txt)
- [\_cache\_jcmd](XTextArea.md#_cache_jcmd)
- [\_children](XTextArea.md#_children)
- [\_data\_source](XTextArea.md#_data_source)
- [\_debug](XTextArea.md#_debug)
- [\_dom\_object](XTextArea.md#_dom_object)
- [\_event\_listeners\_ids](XTextArea.md#_event_listeners_ids)
- [\_html](XTextArea.md#_html)
- [\_html\_ns](XTextArea.md#_html_ns)
- [\_html\_tag](XTextArea.md#_html_tag)
- [\_id](XTextArea.md#_id)
- [\_name](XTextArea.md#_name)
- [\_nano\_commands](XTextArea.md#_nano_commands)
- [\_on](XTextArea.md#_on)
- [\_on\_click](XTextArea.md#_on_click)
- [\_on\_create](XTextArea.md#_on_create)
- [\_on\_data](XTextArea.md#_on_data)
- [\_on\_event](XTextArea.md#_on_event)
- [\_on\_frame](XTextArea.md#_on_frame)
- [\_on\_hide](XTextArea.md#_on_hide)
- [\_on\_hide\_animation](XTextArea.md#_on_hide_animation)
- [\_on\_mount](XTextArea.md#_on_mount)
- [\_on\_show](XTextArea.md#_on_show)
- [\_on\_show\_animation](XTextArea.md#_on_show_animation)
- [\_once](XTextArea.md#_once)
- [\_parent](XTextArea.md#_parent)
- [\_parent\_element](XTextArea.md#_parent_element)
- [\_process\_data](XTextArea.md#_process_data)
- [\_process\_frame](XTextArea.md#_process_frame)
- [\_type](XTextArea.md#_type)
- [\_visible](XTextArea.md#_visible)
- [\_xem\_options](XTextArea.md#_xem_options)
- [\_xporter](XTextArea.md#_xporter)
- [\_xtype](XTextArea.md#_xtype)

### Accessors

- [\_text](XTextArea.md#_text)
- [dom](XTextArea.md#dom)

### Methods

- [addChild](XTextArea.md#addchild)
- [addClass](XTextArea.md#addclass)
- [addEventListener](XTextArea.md#addeventlistener)
- [addNanoCommand](XTextArea.md#addnanocommand)
- [addNanoCommandPack](XTextArea.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XTextArea.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XTextArea.md#addxporterinstancexporter)
- [animate](XTextArea.md#animate)
- [append](XTextArea.md#append)
- [attach](XTextArea.md#attach)
- [checkAndRunInternalFunction](XTextArea.md#checkandruninternalfunction)
- [clearAttributes](XTextArea.md#clearattributes)
- [click](XTextArea.md#click)
- [dispose](XTextArea.md#dispose)
- [emptyDataSource](XTextArea.md#emptydatasource)
- [execute](XTextArea.md#execute)
- [getDOMObject](XTextArea.md#getdomobject)
- [getHTML](XTextArea.md#gethtml)
- [hide](XTextArea.md#hide)
- [init](XTextArea.md#init)
- [log](XTextArea.md#log)
- [mount](XTextArea.md#mount)
- [onCreate](XTextArea.md#oncreate)
- [onData](XTextArea.md#ondata)
- [onFrame](XTextArea.md#onframe)
- [onHide](XTextArea.md#onhide)
- [onMount](XTextArea.md#onmount)
- [onShow](XTextArea.md#onshow)
- [parse](XTextArea.md#parse)
- [parseEvents](XTextArea.md#parseevents)
- [parseFields](XTextArea.md#parsefields)
- [parseFieldsFromXDataObject](XTextArea.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XTextArea.md#removealleventlisteners)
- [removeChild](XTextArea.md#removechild)
- [removeClass](XTextArea.md#removeclass)
- [removeEventListener](XTextArea.md#removeeventlistener)
- [replaceClass](XTextArea.md#replaceclass)
- [run](XTextArea.md#run)
- [setStyleAttribute](XTextArea.md#setstyleattribute)
- [setText](XTextArea.md#settext)
- [show](XTextArea.md#show)
- [stopAnimation](XTextArea.md#stopanimation)
- [toString](XTextArea.md#tostring)
- [toXData](XTextArea.md#toxdata)
- [toggle](XTextArea.md#toggle)
- [toggleClass](XTextArea.md#toggleclass)

## Constructors

### constructor

• **new XTextArea**(`data`): [`XTextArea`](XTextArea.md)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:257](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L257)
...
▪ `Static` **\_xtype**: `string` = `"textarea"`

#### Defined in

[web/xpell-ui/src/XUI/XUICoreObjects.ts:256](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L256)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:269](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L269)
