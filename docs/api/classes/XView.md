[xpell-ui - v2.0.0-alpha.1](../README.md) / XView
...
- [constructor](XView.md#constructor)

### Properties

- [\_base\_display](XView.md#_base_display)
- [\_cache\_cmd\_txt](XView.md#_cache_cmd_txt)
- [\_cache\_jcmd](XView.md#_cache_jcmd)
- [\_children](XView.md#_children)
- [\_data\_source](XView.md#_data_source)
- [\_debug](XView.md#_debug)
- [\_dom\_object](XView.md#_dom_object)
- [\_event\_listeners\_ids](XView.md#_event_listeners_ids)
- [\_html](XView.md#_html)
- [\_html\_ns](XView.md#_html_ns)
- [\_html\_tag](XView.md#_html_tag)
- [\_id](XView.md#_id)
- [\_name](XView.md#_name)
- [\_nano\_commands](XView.md#_nano_commands)
- [\_on](XView.md#_on)
- [\_on\_click](XView.md#_on_click)
- [\_on\_create](XView.md#_on_create)
- [\_on\_data](XView.md#_on_data)
- [\_on\_event](XView.md#_on_event)
- [\_on\_frame](XView.md#_on_frame)
- [\_on\_hide](XView.md#_on_hide)
- [\_on\_hide\_animation](XView.md#_on_hide_animation)
- [\_on\_mount](XView.md#_on_mount)
- [\_on\_show](XView.md#_on_show)
- [\_on\_show\_animation](XView.md#_on_show_animation)
- [\_once](XView.md#_once)
- [\_parent](XView.md#_parent)
- [\_parent\_element](XView.md#_parent_element)
- [\_process\_data](XView.md#_process_data)
- [\_process\_frame](XView.md#_process_frame)
- [\_type](XView.md#_type)
- [\_visible](XView.md#_visible)
- [\_xem\_options](XView.md#_xem_options)
- [\_xporter](XView.md#_xporter)
- [\_xtype](XView.md#_xtype)

### Accessors

- [\_text](XView.md#_text)
- [dom](XView.md#dom)

### Methods

- [addChild](XView.md#addchild)
- [addClass](XView.md#addclass)
- [addEventListener](XView.md#addeventlistener)
- [addNanoCommand](XView.md#addnanocommand)
- [addNanoCommandPack](XView.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XView.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XView.md#addxporterinstancexporter)
- [animate](XView.md#animate)
- [append](XView.md#append)
- [attach](XView.md#attach)
- [checkAndRunInternalFunction](XView.md#checkandruninternalfunction)
- [clearAttributes](XView.md#clearattributes)
- [click](XView.md#click)
- [dispose](XView.md#dispose)
- [emptyDataSource](XView.md#emptydatasource)
- [execute](XView.md#execute)
- [getDOMObject](XView.md#getdomobject)
- [getHTML](XView.md#gethtml)
- [hide](XView.md#hide)
- [init](XView.md#init)
- [log](XView.md#log)
- [mount](XView.md#mount)
- [onCreate](XView.md#oncreate)
- [onData](XView.md#ondata)
- [onFrame](XView.md#onframe)
- [onHide](XView.md#onhide)
- [onMount](XView.md#onmount)
- [onShow](XView.md#onshow)
- [parse](XView.md#parse)
- [parseEvents](XView.md#parseevents)
- [parseFields](XView.md#parsefields)
- [parseFieldsFromXDataObject](XView.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XView.md#removealleventlisteners)
- [removeChild](XView.md#removechild)
- [removeClass](XView.md#removeclass)
- [removeEventListener](XView.md#removeeventlistener)
- [replaceClass](XView.md#replaceclass)
- [run](XView.md#run)
- [setStyleAttribute](XView.md#setstyleattribute)
- [setText](XView.md#settext)
- [show](XView.md#show)
- [stopAnimation](XView.md#stopanimation)
- [toString](XView.md#tostring)
- [toXData](XView.md#toxdata)
- [toggle](XView.md#toggle)
- [toggleClass](XView.md#toggleclass)

## Constructors

### constructor

• **new XView**(`data`): [`XView`](XView.md)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:16](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L16)
...
▪ `Static` **\_xtype**: `string` = `"view"`

#### Defined in

[web/xpell-ui/src/XUI/XUICoreObjects.ts:14](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L14)
