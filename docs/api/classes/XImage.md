[xpell-ui - v2.0.0-alpha.1](../README.md) / XImage
...
- [constructor](XImage.md#constructor)

### Properties

- [\_base\_display](XImage.md#_base_display)
- [\_cache\_cmd\_txt](XImage.md#_cache_cmd_txt)
- [\_cache\_jcmd](XImage.md#_cache_jcmd)
- [\_children](XImage.md#_children)
- [\_data\_source](XImage.md#_data_source)
- [\_debug](XImage.md#_debug)
- [\_dom\_object](XImage.md#_dom_object)
- [\_event\_listeners\_ids](XImage.md#_event_listeners_ids)
- [\_html](XImage.md#_html)
- [\_html\_ns](XImage.md#_html_ns)
- [\_html\_tag](XImage.md#_html_tag)
- [\_id](XImage.md#_id)
- [\_name](XImage.md#_name)
- [\_nano\_commands](XImage.md#_nano_commands)
- [\_on](XImage.md#_on)
- [\_on\_click](XImage.md#_on_click)
- [\_on\_create](XImage.md#_on_create)
- [\_on\_data](XImage.md#_on_data)
- [\_on\_event](XImage.md#_on_event)
- [\_on\_frame](XImage.md#_on_frame)
- [\_on\_hide](XImage.md#_on_hide)
- [\_on\_hide\_animation](XImage.md#_on_hide_animation)
- [\_on\_mount](XImage.md#_on_mount)
- [\_on\_show](XImage.md#_on_show)
- [\_on\_show\_animation](XImage.md#_on_show_animation)
- [\_once](XImage.md#_once)
- [\_parent](XImage.md#_parent)
- [\_parent\_element](XImage.md#_parent_element)
- [\_process\_data](XImage.md#_process_data)
- [\_process\_frame](XImage.md#_process_frame)
- [\_type](XImage.md#_type)
- [\_visible](XImage.md#_visible)
- [\_xem\_options](XImage.md#_xem_options)
- [\_xporter](XImage.md#_xporter)
- [\_xtype](XImage.md#_xtype)

### Accessors

- [\_text](XImage.md#_text)
- [dom](XImage.md#dom)

### Methods

- [addChild](XImage.md#addchild)
- [addClass](XImage.md#addclass)
- [addEventListener](XImage.md#addeventlistener)
- [addNanoCommand](XImage.md#addnanocommand)
- [addNanoCommandPack](XImage.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XImage.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XImage.md#addxporterinstancexporter)
- [animate](XImage.md#animate)
- [append](XImage.md#append)
- [attach](XImage.md#attach)
- [checkAndRunInternalFunction](XImage.md#checkandruninternalfunction)
- [clearAttributes](XImage.md#clearattributes)
- [click](XImage.md#click)
- [dispose](XImage.md#dispose)
- [emptyDataSource](XImage.md#emptydatasource)
- [execute](XImage.md#execute)
- [getDOMObject](XImage.md#getdomobject)
- [getHTML](XImage.md#gethtml)
- [hide](XImage.md#hide)
- [init](XImage.md#init)
- [log](XImage.md#log)
- [mount](XImage.md#mount)
- [onCreate](XImage.md#oncreate)
- [onData](XImage.md#ondata)
- [onFrame](XImage.md#onframe)
- [onHide](XImage.md#onhide)
- [onMount](XImage.md#onmount)
- [onShow](XImage.md#onshow)
- [parse](XImage.md#parse)
- [parseEvents](XImage.md#parseevents)
- [parseFields](XImage.md#parsefields)
- [parseFieldsFromXDataObject](XImage.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XImage.md#removealleventlisteners)
- [removeChild](XImage.md#removechild)
- [removeClass](XImage.md#removeclass)
- [removeEventListener](XImage.md#removeeventlistener)
- [replaceClass](XImage.md#replaceclass)
- [run](XImage.md#run)
- [setStyleAttribute](XImage.md#setstyleattribute)
- [setText](XImage.md#settext)
- [show](XImage.md#show)
- [stopAnimation](XImage.md#stopanimation)
- [toString](XImage.md#tostring)
- [toXData](XImage.md#toxdata)
- [toggle](XImage.md#toggle)
- [toggleClass](XImage.md#toggleclass)

## Constructors

### constructor

• **new XImage**(`data`): [`XImage`](XImage.md)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:74](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L74)
...
▪ `Static` **\_xtype**: `string` = `"image"`

#### Defined in

[web/xpell-ui/src/XUI/XUICoreObjects.ts:72](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L72)
