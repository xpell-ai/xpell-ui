[xpell-ui - v2.0.0-alpha.1](../README.md) / XSVGRect
...
- [constructor](XSVGRect.md#constructor)

### Properties

- [\_base\_display](XSVGRect.md#_base_display)
- [\_cache\_cmd\_txt](XSVGRect.md#_cache_cmd_txt)
- [\_cache\_jcmd](XSVGRect.md#_cache_jcmd)
- [\_children](XSVGRect.md#_children)
- [\_data\_source](XSVGRect.md#_data_source)
- [\_debug](XSVGRect.md#_debug)
- [\_dom\_object](XSVGRect.md#_dom_object)
- [\_event\_listeners\_ids](XSVGRect.md#_event_listeners_ids)
- [\_html](XSVGRect.md#_html)
- [\_html\_ns](XSVGRect.md#_html_ns)
- [\_html\_tag](XSVGRect.md#_html_tag)
- [\_id](XSVGRect.md#_id)
- [\_name](XSVGRect.md#_name)
- [\_nano\_commands](XSVGRect.md#_nano_commands)
- [\_on](XSVGRect.md#_on)
- [\_on\_click](XSVGRect.md#_on_click)
- [\_on\_create](XSVGRect.md#_on_create)
- [\_on\_data](XSVGRect.md#_on_data)
- [\_on\_event](XSVGRect.md#_on_event)
- [\_on\_frame](XSVGRect.md#_on_frame)
- [\_on\_hide](XSVGRect.md#_on_hide)
- [\_on\_hide\_animation](XSVGRect.md#_on_hide_animation)
- [\_on\_mount](XSVGRect.md#_on_mount)
- [\_on\_show](XSVGRect.md#_on_show)
- [\_on\_show\_animation](XSVGRect.md#_on_show_animation)
- [\_once](XSVGRect.md#_once)
- [\_parent](XSVGRect.md#_parent)
- [\_parent\_element](XSVGRect.md#_parent_element)
- [\_process\_data](XSVGRect.md#_process_data)
- [\_process\_frame](XSVGRect.md#_process_frame)
- [\_type](XSVGRect.md#_type)
- [\_visible](XSVGRect.md#_visible)
- [\_xem\_options](XSVGRect.md#_xem_options)
- [\_xporter](XSVGRect.md#_xporter)
- [\_xtype](XSVGRect.md#_xtype)

### Accessors

- [\_text](XSVGRect.md#_text)
- [dom](XSVGRect.md#dom)

### Methods

- [addChild](XSVGRect.md#addchild)
- [addClass](XSVGRect.md#addclass)
- [addEventListener](XSVGRect.md#addeventlistener)
- [addNanoCommand](XSVGRect.md#addnanocommand)
- [addNanoCommandPack](XSVGRect.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XSVGRect.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XSVGRect.md#addxporterinstancexporter)
- [animate](XSVGRect.md#animate)
- [append](XSVGRect.md#append)
- [attach](XSVGRect.md#attach)
- [checkAndRunInternalFunction](XSVGRect.md#checkandruninternalfunction)
- [clearAttributes](XSVGRect.md#clearattributes)
- [click](XSVGRect.md#click)
- [dispose](XSVGRect.md#dispose)
- [emptyDataSource](XSVGRect.md#emptydatasource)
- [execute](XSVGRect.md#execute)
- [getDOMObject](XSVGRect.md#getdomobject)
- [getHTML](XSVGRect.md#gethtml)
- [hide](XSVGRect.md#hide)
- [init](XSVGRect.md#init)
- [log](XSVGRect.md#log)
- [mount](XSVGRect.md#mount)
- [onCreate](XSVGRect.md#oncreate)
- [onData](XSVGRect.md#ondata)
- [onFrame](XSVGRect.md#onframe)
- [onHide](XSVGRect.md#onhide)
- [onMount](XSVGRect.md#onmount)
- [onShow](XSVGRect.md#onshow)
- [parse](XSVGRect.md#parse)
- [parseEvents](XSVGRect.md#parseevents)
- [parseFields](XSVGRect.md#parsefields)
- [parseFieldsFromXDataObject](XSVGRect.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XSVGRect.md#removealleventlisteners)
- [removeChild](XSVGRect.md#removechild)
- [removeClass](XSVGRect.md#removeclass)
- [removeEventListener](XSVGRect.md#removeeventlistener)
- [replaceClass](XSVGRect.md#replaceclass)
- [run](XSVGRect.md#run)
- [setStyleAttribute](XSVGRect.md#setstyleattribute)
- [setText](XSVGRect.md#settext)
- [show](XSVGRect.md#show)
- [stopAnimation](XSVGRect.md#stopanimation)
- [toString](XSVGRect.md#tostring)
- [toXData](XSVGRect.md#toxdata)
- [toggle](XSVGRect.md#toggle)
- [toggleClass](XSVGRect.md#toggleclass)

## Constructors

### constructor

• **new XSVGRect**(`data`): [`XSVGRect`](XSVGRect.md)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:527](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L527)
...
▪ `Static` **\_xtype**: `string` = `"rect"`

#### Defined in

[web/xpell-ui/src/XUI/XUICoreObjects.ts:525](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L525)
