[xpell-ui - v2.0.0-alpha.1](../README.md) / XSVGCircle
...
- [constructor](XSVGCircle.md#constructor)

### Properties

- [\_base\_display](XSVGCircle.md#_base_display)
- [\_cache\_cmd\_txt](XSVGCircle.md#_cache_cmd_txt)
- [\_cache\_jcmd](XSVGCircle.md#_cache_jcmd)
- [\_children](XSVGCircle.md#_children)
- [\_data\_source](XSVGCircle.md#_data_source)
- [\_debug](XSVGCircle.md#_debug)
- [\_dom\_object](XSVGCircle.md#_dom_object)
- [\_event\_listeners\_ids](XSVGCircle.md#_event_listeners_ids)
- [\_html](XSVGCircle.md#_html)
- [\_html\_ns](XSVGCircle.md#_html_ns)
- [\_html\_tag](XSVGCircle.md#_html_tag)
- [\_id](XSVGCircle.md#_id)
- [\_name](XSVGCircle.md#_name)
- [\_nano\_commands](XSVGCircle.md#_nano_commands)
- [\_on](XSVGCircle.md#_on)
- [\_on\_click](XSVGCircle.md#_on_click)
- [\_on\_create](XSVGCircle.md#_on_create)
- [\_on\_data](XSVGCircle.md#_on_data)
- [\_on\_event](XSVGCircle.md#_on_event)
- [\_on\_frame](XSVGCircle.md#_on_frame)
- [\_on\_hide](XSVGCircle.md#_on_hide)
- [\_on\_hide\_animation](XSVGCircle.md#_on_hide_animation)
- [\_on\_mount](XSVGCircle.md#_on_mount)
- [\_on\_show](XSVGCircle.md#_on_show)
- [\_on\_show\_animation](XSVGCircle.md#_on_show_animation)
- [\_once](XSVGCircle.md#_once)
- [\_parent](XSVGCircle.md#_parent)
- [\_parent\_element](XSVGCircle.md#_parent_element)
- [\_process\_data](XSVGCircle.md#_process_data)
- [\_process\_frame](XSVGCircle.md#_process_frame)
- [\_type](XSVGCircle.md#_type)
- [\_visible](XSVGCircle.md#_visible)
- [\_xem\_options](XSVGCircle.md#_xem_options)
- [\_xporter](XSVGCircle.md#_xporter)
- [\_xtype](XSVGCircle.md#_xtype)

### Accessors

- [\_text](XSVGCircle.md#_text)
- [dom](XSVGCircle.md#dom)

### Methods

- [addChild](XSVGCircle.md#addchild)
- [addClass](XSVGCircle.md#addclass)
- [addEventListener](XSVGCircle.md#addeventlistener)
- [addNanoCommand](XSVGCircle.md#addnanocommand)
- [addNanoCommandPack](XSVGCircle.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XSVGCircle.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XSVGCircle.md#addxporterinstancexporter)
- [animate](XSVGCircle.md#animate)
- [append](XSVGCircle.md#append)
- [attach](XSVGCircle.md#attach)
- [checkAndRunInternalFunction](XSVGCircle.md#checkandruninternalfunction)
- [clearAttributes](XSVGCircle.md#clearattributes)
- [click](XSVGCircle.md#click)
- [dispose](XSVGCircle.md#dispose)
- [emptyDataSource](XSVGCircle.md#emptydatasource)
- [execute](XSVGCircle.md#execute)
- [getDOMObject](XSVGCircle.md#getdomobject)
- [getHTML](XSVGCircle.md#gethtml)
- [hide](XSVGCircle.md#hide)
- [init](XSVGCircle.md#init)
- [log](XSVGCircle.md#log)
- [mount](XSVGCircle.md#mount)
- [onCreate](XSVGCircle.md#oncreate)
- [onData](XSVGCircle.md#ondata)
- [onFrame](XSVGCircle.md#onframe)
- [onHide](XSVGCircle.md#onhide)
- [onMount](XSVGCircle.md#onmount)
- [onShow](XSVGCircle.md#onshow)
- [parse](XSVGCircle.md#parse)
- [parseEvents](XSVGCircle.md#parseevents)
- [parseFields](XSVGCircle.md#parsefields)
- [parseFieldsFromXDataObject](XSVGCircle.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XSVGCircle.md#removealleventlisteners)
- [removeChild](XSVGCircle.md#removechild)
- [removeClass](XSVGCircle.md#removeclass)
- [removeEventListener](XSVGCircle.md#removeeventlistener)
- [replaceClass](XSVGCircle.md#replaceclass)
- [run](XSVGCircle.md#run)
- [setStyleAttribute](XSVGCircle.md#setstyleattribute)
- [setText](XSVGCircle.md#settext)
- [show](XSVGCircle.md#show)
- [stopAnimation](XSVGCircle.md#stopanimation)
- [toString](XSVGCircle.md#tostring)
- [toXData](XSVGCircle.md#toxdata)
- [toggle](XSVGCircle.md#toggle)
- [toggleClass](XSVGCircle.md#toggleclass)

## Constructors

### constructor

• **new XSVGCircle**(`data`): [`XSVGCircle`](XSVGCircle.md)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:495](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L495)
...
▪ `Static` **\_xtype**: `string` = `"circle"`

#### Defined in

[web/xpell-ui/src/XUI/XUICoreObjects.ts:493](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L493)
