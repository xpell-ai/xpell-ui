[xpell-ui - v2.0.0-alpha.1](../README.md) / XSVGPolygon
...
- [constructor](XSVGPolygon.md#constructor)

### Properties

- [\_base\_display](XSVGPolygon.md#_base_display)
- [\_cache\_cmd\_txt](XSVGPolygon.md#_cache_cmd_txt)
- [\_cache\_jcmd](XSVGPolygon.md#_cache_jcmd)
- [\_children](XSVGPolygon.md#_children)
- [\_data\_source](XSVGPolygon.md#_data_source)
- [\_debug](XSVGPolygon.md#_debug)
- [\_dom\_object](XSVGPolygon.md#_dom_object)
- [\_event\_listeners\_ids](XSVGPolygon.md#_event_listeners_ids)
- [\_html](XSVGPolygon.md#_html)
- [\_html\_ns](XSVGPolygon.md#_html_ns)
- [\_html\_tag](XSVGPolygon.md#_html_tag)
- [\_id](XSVGPolygon.md#_id)
- [\_name](XSVGPolygon.md#_name)
- [\_nano\_commands](XSVGPolygon.md#_nano_commands)
- [\_on](XSVGPolygon.md#_on)
- [\_on\_click](XSVGPolygon.md#_on_click)
- [\_on\_create](XSVGPolygon.md#_on_create)
- [\_on\_data](XSVGPolygon.md#_on_data)
- [\_on\_event](XSVGPolygon.md#_on_event)
- [\_on\_frame](XSVGPolygon.md#_on_frame)
- [\_on\_hide](XSVGPolygon.md#_on_hide)
- [\_on\_hide\_animation](XSVGPolygon.md#_on_hide_animation)
- [\_on\_mount](XSVGPolygon.md#_on_mount)
- [\_on\_show](XSVGPolygon.md#_on_show)
- [\_on\_show\_animation](XSVGPolygon.md#_on_show_animation)
- [\_once](XSVGPolygon.md#_once)
- [\_parent](XSVGPolygon.md#_parent)
- [\_parent\_element](XSVGPolygon.md#_parent_element)
- [\_process\_data](XSVGPolygon.md#_process_data)
- [\_process\_frame](XSVGPolygon.md#_process_frame)
- [\_type](XSVGPolygon.md#_type)
- [\_visible](XSVGPolygon.md#_visible)
- [\_xem\_options](XSVGPolygon.md#_xem_options)
- [\_xporter](XSVGPolygon.md#_xporter)
- [\_xtype](XSVGPolygon.md#_xtype)

### Accessors

- [\_text](XSVGPolygon.md#_text)
- [dom](XSVGPolygon.md#dom)

### Methods

- [addChild](XSVGPolygon.md#addchild)
- [addClass](XSVGPolygon.md#addclass)
- [addEventListener](XSVGPolygon.md#addeventlistener)
- [addNanoCommand](XSVGPolygon.md#addnanocommand)
- [addNanoCommandPack](XSVGPolygon.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XSVGPolygon.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XSVGPolygon.md#addxporterinstancexporter)
- [animate](XSVGPolygon.md#animate)
- [append](XSVGPolygon.md#append)
- [attach](XSVGPolygon.md#attach)
- [checkAndRunInternalFunction](XSVGPolygon.md#checkandruninternalfunction)
- [clearAttributes](XSVGPolygon.md#clearattributes)
- [click](XSVGPolygon.md#click)
- [dispose](XSVGPolygon.md#dispose)
- [emptyDataSource](XSVGPolygon.md#emptydatasource)
- [execute](XSVGPolygon.md#execute)
- [getDOMObject](XSVGPolygon.md#getdomobject)
- [getHTML](XSVGPolygon.md#gethtml)
- [hide](XSVGPolygon.md#hide)
- [init](XSVGPolygon.md#init)
- [log](XSVGPolygon.md#log)
- [mount](XSVGPolygon.md#mount)
- [onCreate](XSVGPolygon.md#oncreate)
- [onData](XSVGPolygon.md#ondata)
- [onFrame](XSVGPolygon.md#onframe)
- [onHide](XSVGPolygon.md#onhide)
- [onMount](XSVGPolygon.md#onmount)
- [onShow](XSVGPolygon.md#onshow)
- [parse](XSVGPolygon.md#parse)
- [parseEvents](XSVGPolygon.md#parseevents)
- [parseFields](XSVGPolygon.md#parsefields)
- [parseFieldsFromXDataObject](XSVGPolygon.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XSVGPolygon.md#removealleventlisteners)
- [removeChild](XSVGPolygon.md#removechild)
- [removeClass](XSVGPolygon.md#removeclass)
- [removeEventListener](XSVGPolygon.md#removeeventlistener)
- [replaceClass](XSVGPolygon.md#replaceclass)
- [run](XSVGPolygon.md#run)
- [setStyleAttribute](XSVGPolygon.md#setstyleattribute)
- [setText](XSVGPolygon.md#settext)
- [show](XSVGPolygon.md#show)
- [stopAnimation](XSVGPolygon.md#stopanimation)
- [toString](XSVGPolygon.md#tostring)
- [toXData](XSVGPolygon.md#toxdata)
- [toggle](XSVGPolygon.md#toggle)
- [toggleClass](XSVGPolygon.md#toggleclass)

## Constructors

### constructor

• **new XSVGPolygon**(`data`): [`XSVGPolygon`](XSVGPolygon.md)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:575](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L575)
...
▪ `Static` **\_xtype**: `string` = `"polygon"`

#### Defined in

[web/xpell-ui/src/XUI/XUICoreObjects.ts:573](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L573)
