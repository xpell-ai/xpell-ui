[xpell-ui - v2.0.0-alpha.1](../README.md) / XSVGLine
...
- [constructor](XSVGLine.md#constructor)

### Properties

- [\_base\_display](XSVGLine.md#_base_display)
- [\_cache\_cmd\_txt](XSVGLine.md#_cache_cmd_txt)
- [\_cache\_jcmd](XSVGLine.md#_cache_jcmd)
- [\_children](XSVGLine.md#_children)
- [\_data\_source](XSVGLine.md#_data_source)
- [\_debug](XSVGLine.md#_debug)
- [\_dom\_object](XSVGLine.md#_dom_object)
- [\_event\_listeners\_ids](XSVGLine.md#_event_listeners_ids)
- [\_html](XSVGLine.md#_html)
- [\_html\_ns](XSVGLine.md#_html_ns)
- [\_html\_tag](XSVGLine.md#_html_tag)
- [\_id](XSVGLine.md#_id)
- [\_name](XSVGLine.md#_name)
- [\_nano\_commands](XSVGLine.md#_nano_commands)
- [\_on](XSVGLine.md#_on)
- [\_on\_click](XSVGLine.md#_on_click)
- [\_on\_create](XSVGLine.md#_on_create)
- [\_on\_data](XSVGLine.md#_on_data)
- [\_on\_event](XSVGLine.md#_on_event)
- [\_on\_frame](XSVGLine.md#_on_frame)
- [\_on\_hide](XSVGLine.md#_on_hide)
- [\_on\_hide\_animation](XSVGLine.md#_on_hide_animation)
- [\_on\_mount](XSVGLine.md#_on_mount)
- [\_on\_show](XSVGLine.md#_on_show)
- [\_on\_show\_animation](XSVGLine.md#_on_show_animation)
- [\_once](XSVGLine.md#_once)
- [\_parent](XSVGLine.md#_parent)
- [\_parent\_element](XSVGLine.md#_parent_element)
- [\_process\_data](XSVGLine.md#_process_data)
- [\_process\_frame](XSVGLine.md#_process_frame)
- [\_type](XSVGLine.md#_type)
- [\_visible](XSVGLine.md#_visible)
- [\_xem\_options](XSVGLine.md#_xem_options)
- [\_xporter](XSVGLine.md#_xporter)
- [\_xtype](XSVGLine.md#_xtype)

### Accessors

- [\_text](XSVGLine.md#_text)
- [dom](XSVGLine.md#dom)

### Methods

- [addChild](XSVGLine.md#addchild)
- [addClass](XSVGLine.md#addclass)
- [addEventListener](XSVGLine.md#addeventlistener)
- [addNanoCommand](XSVGLine.md#addnanocommand)
- [addNanoCommandPack](XSVGLine.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XSVGLine.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XSVGLine.md#addxporterinstancexporter)
- [animate](XSVGLine.md#animate)
- [append](XSVGLine.md#append)
- [attach](XSVGLine.md#attach)
- [checkAndRunInternalFunction](XSVGLine.md#checkandruninternalfunction)
- [clearAttributes](XSVGLine.md#clearattributes)
- [click](XSVGLine.md#click)
- [dispose](XSVGLine.md#dispose)
- [emptyDataSource](XSVGLine.md#emptydatasource)
- [execute](XSVGLine.md#execute)
- [getDOMObject](XSVGLine.md#getdomobject)
- [getHTML](XSVGLine.md#gethtml)
- [hide](XSVGLine.md#hide)
- [init](XSVGLine.md#init)
- [log](XSVGLine.md#log)
- [mount](XSVGLine.md#mount)
- [onCreate](XSVGLine.md#oncreate)
- [onData](XSVGLine.md#ondata)
- [onFrame](XSVGLine.md#onframe)
- [onHide](XSVGLine.md#onhide)
- [onMount](XSVGLine.md#onmount)
- [onShow](XSVGLine.md#onshow)
- [parse](XSVGLine.md#parse)
- [parseEvents](XSVGLine.md#parseevents)
- [parseFields](XSVGLine.md#parsefields)
- [parseFieldsFromXDataObject](XSVGLine.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XSVGLine.md#removealleventlisteners)
- [removeChild](XSVGLine.md#removechild)
- [removeClass](XSVGLine.md#removeclass)
- [removeEventListener](XSVGLine.md#removeeventlistener)
- [replaceClass](XSVGLine.md#replaceclass)
- [run](XSVGLine.md#run)
- [setStyleAttribute](XSVGLine.md#setstyleattribute)
- [setText](XSVGLine.md#settext)
- [show](XSVGLine.md#show)
- [stopAnimation](XSVGLine.md#stopanimation)
- [toString](XSVGLine.md#tostring)
- [toXData](XSVGLine.md#toxdata)
- [toggle](XSVGLine.md#toggle)
- [toggleClass](XSVGLine.md#toggleclass)

## Constructors

### constructor

• **new XSVGLine**(`data`): [`XSVGLine`](XSVGLine.md)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:543](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L543)
...
▪ `Static` **\_xtype**: `string` = `"line"`

#### Defined in

[web/xpell-ui/src/XUI/XUICoreObjects.ts:541](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L541)
