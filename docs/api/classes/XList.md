[xpell-ui - v2.0.0-alpha.1](../README.md) / XList
...
- [constructor](XList.md#constructor)

### Properties

- [\_base\_display](XList.md#_base_display)
- [\_cache\_cmd\_txt](XList.md#_cache_cmd_txt)
- [\_cache\_jcmd](XList.md#_cache_jcmd)
- [\_children](XList.md#_children)
- [\_data\_source](XList.md#_data_source)
- [\_debug](XList.md#_debug)
- [\_dom\_object](XList.md#_dom_object)
- [\_event\_listeners\_ids](XList.md#_event_listeners_ids)
- [\_html](XList.md#_html)
- [\_html\_ns](XList.md#_html_ns)
- [\_html\_tag](XList.md#_html_tag)
- [\_id](XList.md#_id)
- [\_items](XList.md#_items)
- [\_name](XList.md#_name)
- [\_nano\_commands](XList.md#_nano_commands)
- [\_on](XList.md#_on)
- [\_on\_click](XList.md#_on_click)
- [\_on\_create](XList.md#_on_create)
- [\_on\_data](XList.md#_on_data)
- [\_on\_event](XList.md#_on_event)
- [\_on\_frame](XList.md#_on_frame)
- [\_on\_hide](XList.md#_on_hide)
- [\_on\_hide\_animation](XList.md#_on_hide_animation)
- [\_on\_mount](XList.md#_on_mount)
- [\_on\_show](XList.md#_on_show)
- [\_on\_show\_animation](XList.md#_on_show_animation)
- [\_once](XList.md#_once)
- [\_parent](XList.md#_parent)
- [\_parent\_element](XList.md#_parent_element)
- [\_process\_data](XList.md#_process_data)
- [\_process\_frame](XList.md#_process_frame)
- [\_type](XList.md#_type)
- [\_visible](XList.md#_visible)
- [\_xem\_options](XList.md#_xem_options)
- [\_xporter](XList.md#_xporter)
- [\_xtype](XList.md#_xtype)

### Accessors

- [\_text](XList.md#_text)
- [dom](XList.md#dom)

### Methods

- [addChild](XList.md#addchild)
- [addClass](XList.md#addclass)
- [addEventListener](XList.md#addeventlistener)
- [addNanoCommand](XList.md#addnanocommand)
- [addNanoCommandPack](XList.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XList.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XList.md#addxporterinstancexporter)
- [animate](XList.md#animate)
- [append](XList.md#append)
- [attach](XList.md#attach)
- [checkAndRunInternalFunction](XList.md#checkandruninternalfunction)
- [clearAttributes](XList.md#clearattributes)
- [click](XList.md#click)
- [dispose](XList.md#dispose)
- [emptyDataSource](XList.md#emptydatasource)
- [execute](XList.md#execute)
- [getDOMObject](XList.md#getdomobject)
- [getHTML](XList.md#gethtml)
- [hide](XList.md#hide)
- [init](XList.md#init)
- [log](XList.md#log)
- [mount](XList.md#mount)
- [onCreate](XList.md#oncreate)
- [onData](XList.md#ondata)
- [onFrame](XList.md#onframe)
- [onHide](XList.md#onhide)
- [onMount](XList.md#onmount)
- [onShow](XList.md#onshow)
- [parse](XList.md#parse)
- [parseEvents](XList.md#parseevents)
- [parseFields](XList.md#parsefields)
- [parseFieldsFromXDataObject](XList.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XList.md#removealleventlisteners)
- [removeChild](XList.md#removechild)
- [removeClass](XList.md#removeclass)
- [removeEventListener](XList.md#removeeventlistener)
- [replaceClass](XList.md#replaceclass)
- [run](XList.md#run)
- [setStyleAttribute](XList.md#setstyleattribute)
- [setText](XList.md#settext)
- [show](XList.md#show)
- [stopAnimation](XList.md#stopanimation)
- [toString](XList.md#tostring)
- [toXData](XList.md#toxdata)
- [toggle](XList.md#toggle)
- [toggleClass](XList.md#toggleclass)

## Constructors

### constructor

• **new XList**(`data`): [`XList`](XList.md)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:345](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L345)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:344](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L344)
...
▪ `Static` **\_xtype**: `string` = `"list"`

#### Defined in

[web/xpell-ui/src/XUI/XUICoreObjects.ts:343](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L343)
