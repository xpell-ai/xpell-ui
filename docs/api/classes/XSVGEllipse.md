[xpell-ui - v2.0.0-alpha.1](../README.md) / XSVGEllipse
...
- [constructor](XSVGEllipse.md#constructor)

### Properties

- [\_base\_display](XSVGEllipse.md#_base_display)
- [\_cache\_cmd\_txt](XSVGEllipse.md#_cache_cmd_txt)
- [\_cache\_jcmd](XSVGEllipse.md#_cache_jcmd)
- [\_children](XSVGEllipse.md#_children)
- [\_data\_source](XSVGEllipse.md#_data_source)
- [\_debug](XSVGEllipse.md#_debug)
- [\_dom\_object](XSVGEllipse.md#_dom_object)
- [\_event\_listeners\_ids](XSVGEllipse.md#_event_listeners_ids)
- [\_html](XSVGEllipse.md#_html)
- [\_html\_ns](XSVGEllipse.md#_html_ns)
- [\_html\_tag](XSVGEllipse.md#_html_tag)
- [\_id](XSVGEllipse.md#_id)
- [\_name](XSVGEllipse.md#_name)
- [\_nano\_commands](XSVGEllipse.md#_nano_commands)
- [\_on](XSVGEllipse.md#_on)
- [\_on\_click](XSVGEllipse.md#_on_click)
- [\_on\_create](XSVGEllipse.md#_on_create)
- [\_on\_data](XSVGEllipse.md#_on_data)
- [\_on\_event](XSVGEllipse.md#_on_event)
- [\_on\_frame](XSVGEllipse.md#_on_frame)
- [\_on\_hide](XSVGEllipse.md#_on_hide)
- [\_on\_hide\_animation](XSVGEllipse.md#_on_hide_animation)
- [\_on\_mount](XSVGEllipse.md#_on_mount)
- [\_on\_show](XSVGEllipse.md#_on_show)
- [\_on\_show\_animation](XSVGEllipse.md#_on_show_animation)
- [\_once](XSVGEllipse.md#_once)
- [\_parent](XSVGEllipse.md#_parent)
- [\_parent\_element](XSVGEllipse.md#_parent_element)
- [\_process\_data](XSVGEllipse.md#_process_data)
- [\_process\_frame](XSVGEllipse.md#_process_frame)
- [\_type](XSVGEllipse.md#_type)
- [\_visible](XSVGEllipse.md#_visible)
- [\_xem\_options](XSVGEllipse.md#_xem_options)
- [\_xporter](XSVGEllipse.md#_xporter)
- [\_xtype](XSVGEllipse.md#_xtype)

### Accessors

- [\_text](XSVGEllipse.md#_text)
- [dom](XSVGEllipse.md#dom)

### Methods

- [addChild](XSVGEllipse.md#addchild)
- [addClass](XSVGEllipse.md#addclass)
- [addEventListener](XSVGEllipse.md#addeventlistener)
- [addNanoCommand](XSVGEllipse.md#addnanocommand)
- [addNanoCommandPack](XSVGEllipse.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XSVGEllipse.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XSVGEllipse.md#addxporterinstancexporter)
- [animate](XSVGEllipse.md#animate)
- [append](XSVGEllipse.md#append)
- [attach](XSVGEllipse.md#attach)
- [checkAndRunInternalFunction](XSVGEllipse.md#checkandruninternalfunction)
- [clearAttributes](XSVGEllipse.md#clearattributes)
- [click](XSVGEllipse.md#click)
- [dispose](XSVGEllipse.md#dispose)
- [emptyDataSource](XSVGEllipse.md#emptydatasource)
- [execute](XSVGEllipse.md#execute)
- [getDOMObject](XSVGEllipse.md#getdomobject)
- [getHTML](XSVGEllipse.md#gethtml)
- [hide](XSVGEllipse.md#hide)
- [init](XSVGEllipse.md#init)
- [log](XSVGEllipse.md#log)
- [mount](XSVGEllipse.md#mount)
- [onCreate](XSVGEllipse.md#oncreate)
- [onData](XSVGEllipse.md#ondata)
- [onFrame](XSVGEllipse.md#onframe)
- [onHide](XSVGEllipse.md#onhide)
- [onMount](XSVGEllipse.md#onmount)
- [onShow](XSVGEllipse.md#onshow)
- [parse](XSVGEllipse.md#parse)
- [parseEvents](XSVGEllipse.md#parseevents)
- [parseFields](XSVGEllipse.md#parsefields)
- [parseFieldsFromXDataObject](XSVGEllipse.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XSVGEllipse.md#removealleventlisteners)
- [removeChild](XSVGEllipse.md#removechild)
- [removeClass](XSVGEllipse.md#removeclass)
- [removeEventListener](XSVGEllipse.md#removeeventlistener)
- [replaceClass](XSVGEllipse.md#replaceclass)
- [run](XSVGEllipse.md#run)
- [setStyleAttribute](XSVGEllipse.md#setstyleattribute)
- [setText](XSVGEllipse.md#settext)
- [show](XSVGEllipse.md#show)
- [stopAnimation](XSVGEllipse.md#stopanimation)
- [toString](XSVGEllipse.md#tostring)
- [toXData](XSVGEllipse.md#toxdata)
- [toggle](XSVGEllipse.md#toggle)
- [toggleClass](XSVGEllipse.md#toggleclass)

## Constructors

### constructor

• **new XSVGEllipse**(`data`): [`XSVGEllipse`](XSVGEllipse.md)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:511](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L511)
...
▪ `Static` **\_xtype**: `string` = `"ellipse"`

#### Defined in

[web/xpell-ui/src/XUI/XUICoreObjects.ts:509](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L509)
