[xpell-ui - v2.0.0-alpha.1](../README.md) / XNavBar
...
- [constructor](XNavBar.md#constructor)

### Properties

- [\_base\_display](XNavBar.md#_base_display)
- [\_cache\_cmd\_txt](XNavBar.md#_cache_cmd_txt)
- [\_cache\_jcmd](XNavBar.md#_cache_jcmd)
- [\_children](XNavBar.md#_children)
- [\_data\_source](XNavBar.md#_data_source)
- [\_debug](XNavBar.md#_debug)
- [\_dom\_object](XNavBar.md#_dom_object)
- [\_event\_listeners\_ids](XNavBar.md#_event_listeners_ids)
- [\_html](XNavBar.md#_html)
- [\_html\_ns](XNavBar.md#_html_ns)
- [\_html\_tag](XNavBar.md#_html_tag)
- [\_id](XNavBar.md#_id)
- [\_name](XNavBar.md#_name)
- [\_nano\_commands](XNavBar.md#_nano_commands)
- [\_on](XNavBar.md#_on)
- [\_on\_click](XNavBar.md#_on_click)
- [\_on\_create](XNavBar.md#_on_create)
- [\_on\_data](XNavBar.md#_on_data)
- [\_on\_event](XNavBar.md#_on_event)
- [\_on\_frame](XNavBar.md#_on_frame)
- [\_on\_hide](XNavBar.md#_on_hide)
- [\_on\_hide\_animation](XNavBar.md#_on_hide_animation)
- [\_on\_mount](XNavBar.md#_on_mount)
- [\_on\_show](XNavBar.md#_on_show)
- [\_on\_show\_animation](XNavBar.md#_on_show_animation)
- [\_once](XNavBar.md#_once)
- [\_parent](XNavBar.md#_parent)
- [\_parent\_element](XNavBar.md#_parent_element)
- [\_process\_data](XNavBar.md#_process_data)
- [\_process\_frame](XNavBar.md#_process_frame)
- [\_type](XNavBar.md#_type)
- [\_visible](XNavBar.md#_visible)
- [\_xem\_options](XNavBar.md#_xem_options)
- [\_xporter](XNavBar.md#_xporter)
- [\_xtype](XNavBar.md#_xtype)

### Accessors

- [\_text](XNavBar.md#_text)
- [dom](XNavBar.md#dom)

### Methods

- [addChild](XNavBar.md#addchild)
- [addClass](XNavBar.md#addclass)
- [addEventListener](XNavBar.md#addeventlistener)
- [addNanoCommand](XNavBar.md#addnanocommand)
- [addNanoCommandPack](XNavBar.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XNavBar.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XNavBar.md#addxporterinstancexporter)
- [animate](XNavBar.md#animate)
- [append](XNavBar.md#append)
- [attach](XNavBar.md#attach)
- [checkAndRunInternalFunction](XNavBar.md#checkandruninternalfunction)
- [clearAttributes](XNavBar.md#clearattributes)
- [click](XNavBar.md#click)
- [dispose](XNavBar.md#dispose)
- [emptyDataSource](XNavBar.md#emptydatasource)
- [execute](XNavBar.md#execute)
- [getDOMObject](XNavBar.md#getdomobject)
- [getHTML](XNavBar.md#gethtml)
- [hide](XNavBar.md#hide)
- [init](XNavBar.md#init)
- [log](XNavBar.md#log)
- [mount](XNavBar.md#mount)
- [onCreate](XNavBar.md#oncreate)
- [onData](XNavBar.md#ondata)
- [onFrame](XNavBar.md#onframe)
- [onHide](XNavBar.md#onhide)
- [onMount](XNavBar.md#onmount)
- [onShow](XNavBar.md#onshow)
- [parse](XNavBar.md#parse)
- [parseEvents](XNavBar.md#parseevents)
- [parseFields](XNavBar.md#parsefields)
- [parseFieldsFromXDataObject](XNavBar.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XNavBar.md#removealleventlisteners)
- [removeChild](XNavBar.md#removechild)
- [removeClass](XNavBar.md#removeclass)
- [removeEventListener](XNavBar.md#removeeventlistener)
- [replaceClass](XNavBar.md#replaceclass)
- [run](XNavBar.md#run)
- [setStyleAttribute](XNavBar.md#setstyleattribute)
- [setText](XNavBar.md#settext)
- [show](XNavBar.md#show)
- [stopAnimation](XNavBar.md#stopanimation)
- [toString](XNavBar.md#tostring)
- [toXData](XNavBar.md#toxdata)
- [toggle](XNavBar.md#toggle)
- [toggleClass](XNavBar.md#toggleclass)

## Constructors

### constructor

• **new XNavBar**(`data`): [`XNavBar`](XNavBar.md)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:43](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L43)
...
▪ `Static` **\_xtype**: `string` = `"navbar"`

#### Defined in

[web/xpell-ui/src/XUI/XUICoreObjects.ts:42](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L42)
