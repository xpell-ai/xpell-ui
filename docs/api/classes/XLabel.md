[xpell-ui - v2.0.0-alpha.1](../README.md) / XLabel
...
- [constructor](XLabel.md#constructor)

### Properties

- [\_base\_display](XLabel.md#_base_display)
- [\_cache\_cmd\_txt](XLabel.md#_cache_cmd_txt)
- [\_cache\_jcmd](XLabel.md#_cache_jcmd)
- [\_children](XLabel.md#_children)
- [\_data\_source](XLabel.md#_data_source)
- [\_debug](XLabel.md#_debug)
- [\_dom\_object](XLabel.md#_dom_object)
- [\_event\_listeners\_ids](XLabel.md#_event_listeners_ids)
- [\_html](XLabel.md#_html)
- [\_html\_ns](XLabel.md#_html_ns)
- [\_html\_tag](XLabel.md#_html_tag)
- [\_id](XLabel.md#_id)
- [\_name](XLabel.md#_name)
- [\_nano\_commands](XLabel.md#_nano_commands)
- [\_on](XLabel.md#_on)
- [\_on\_click](XLabel.md#_on_click)
- [\_on\_create](XLabel.md#_on_create)
- [\_on\_data](XLabel.md#_on_data)
- [\_on\_event](XLabel.md#_on_event)
- [\_on\_frame](XLabel.md#_on_frame)
- [\_on\_hide](XLabel.md#_on_hide)
- [\_on\_hide\_animation](XLabel.md#_on_hide_animation)
- [\_on\_mount](XLabel.md#_on_mount)
- [\_on\_show](XLabel.md#_on_show)
- [\_on\_show\_animation](XLabel.md#_on_show_animation)
- [\_once](XLabel.md#_once)
- [\_parent](XLabel.md#_parent)
- [\_parent\_element](XLabel.md#_parent_element)
- [\_process\_data](XLabel.md#_process_data)
- [\_process\_frame](XLabel.md#_process_frame)
- [\_type](XLabel.md#_type)
- [\_visible](XLabel.md#_visible)
- [\_xem\_options](XLabel.md#_xem_options)
- [\_xporter](XLabel.md#_xporter)
- [\_xtype](XLabel.md#_xtype)

### Accessors

- [\_text](XLabel.md#_text)
- [dom](XLabel.md#dom)

### Methods

- [addChild](XLabel.md#addchild)
- [addClass](XLabel.md#addclass)
- [addEventListener](XLabel.md#addeventlistener)
- [addNanoCommand](XLabel.md#addnanocommand)
- [addNanoCommandPack](XLabel.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XLabel.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XLabel.md#addxporterinstancexporter)
- [animate](XLabel.md#animate)
- [append](XLabel.md#append)
- [attach](XLabel.md#attach)
- [checkAndRunInternalFunction](XLabel.md#checkandruninternalfunction)
- [clearAttributes](XLabel.md#clearattributes)
- [click](XLabel.md#click)
- [dispose](XLabel.md#dispose)
- [emptyDataSource](XLabel.md#emptydatasource)
- [execute](XLabel.md#execute)
- [getDOMObject](XLabel.md#getdomobject)
- [getHTML](XLabel.md#gethtml)
- [hide](XLabel.md#hide)
- [init](XLabel.md#init)
- [log](XLabel.md#log)
- [mount](XLabel.md#mount)
- [onCreate](XLabel.md#oncreate)
- [onData](XLabel.md#ondata)
- [onFrame](XLabel.md#onframe)
- [onHide](XLabel.md#onhide)
- [onMount](XLabel.md#onmount)
- [onShow](XLabel.md#onshow)
- [parse](XLabel.md#parse)
- [parseEvents](XLabel.md#parseevents)
- [parseFields](XLabel.md#parsefields)
- [parseFieldsFromXDataObject](XLabel.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XLabel.md#removealleventlisteners)
- [removeChild](XLabel.md#removechild)
- [removeClass](XLabel.md#removeclass)
- [removeEventListener](XLabel.md#removeeventlistener)
- [replaceClass](XLabel.md#replaceclass)
- [run](XLabel.md#run)
- [setStyleAttribute](XLabel.md#setstyleattribute)
- [setText](XLabel.md#settext)
- [show](XLabel.md#show)
- [stopAnimation](XLabel.md#stopanimation)
- [toString](XLabel.md#tostring)
- [toXData](XLabel.md#toxdata)
- [toggle](XLabel.md#toggle)
- [toggleClass](XLabel.md#toggleclass)

## Constructors

### constructor

• **new XLabel**(`data`): [`XLabel`](XLabel.md)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:295](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L295)
...
▪ `Static` **\_xtype**: `string` = `"label"`

#### Defined in

[web/xpell-ui/src/XUI/XUICoreObjects.ts:294](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L294)
