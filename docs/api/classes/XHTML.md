[xpell-ui - v2.0.0-alpha.1](../README.md) / XHTML
...
- [constructor](XHTML.md#constructor)

### Properties

- [\_base\_display](XHTML.md#_base_display)
- [\_cache\_cmd\_txt](XHTML.md#_cache_cmd_txt)
- [\_cache\_jcmd](XHTML.md#_cache_jcmd)
- [\_children](XHTML.md#_children)
- [\_data\_source](XHTML.md#_data_source)
- [\_debug](XHTML.md#_debug)
- [\_dom\_object](XHTML.md#_dom_object)
- [\_event\_listeners\_ids](XHTML.md#_event_listeners_ids)
- [\_html](XHTML.md#_html)
- [\_html\_ns](XHTML.md#_html_ns)
- [\_html\_tag](XHTML.md#_html_tag)
- [\_id](XHTML.md#_id)
- [\_name](XHTML.md#_name)
- [\_nano\_commands](XHTML.md#_nano_commands)
- [\_on](XHTML.md#_on)
- [\_on\_click](XHTML.md#_on_click)
- [\_on\_create](XHTML.md#_on_create)
- [\_on\_data](XHTML.md#_on_data)
- [\_on\_event](XHTML.md#_on_event)
- [\_on\_frame](XHTML.md#_on_frame)
- [\_on\_hide](XHTML.md#_on_hide)
- [\_on\_hide\_animation](XHTML.md#_on_hide_animation)
- [\_on\_mount](XHTML.md#_on_mount)
- [\_on\_show](XHTML.md#_on_show)
- [\_on\_show\_animation](XHTML.md#_on_show_animation)
- [\_once](XHTML.md#_once)
- [\_parent](XHTML.md#_parent)
- [\_parent\_element](XHTML.md#_parent_element)
- [\_process\_data](XHTML.md#_process_data)
- [\_process\_frame](XHTML.md#_process_frame)
- [\_type](XHTML.md#_type)
- [\_visible](XHTML.md#_visible)
- [\_xem\_options](XHTML.md#_xem_options)
- [\_xporter](XHTML.md#_xporter)
- [\_xtype](XHTML.md#_xtype)

### Accessors

- [\_text](XHTML.md#_text)
- [dom](XHTML.md#dom)

### Methods

- [addChild](XHTML.md#addchild)
- [addClass](XHTML.md#addclass)
- [addEventListener](XHTML.md#addeventlistener)
- [addNanoCommand](XHTML.md#addnanocommand)
- [addNanoCommandPack](XHTML.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XHTML.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XHTML.md#addxporterinstancexporter)
- [animate](XHTML.md#animate)
- [append](XHTML.md#append)
- [attach](XHTML.md#attach)
- [checkAndRunInternalFunction](XHTML.md#checkandruninternalfunction)
- [clearAttributes](XHTML.md#clearattributes)
- [click](XHTML.md#click)
- [dispose](XHTML.md#dispose)
- [emptyDataSource](XHTML.md#emptydatasource)
- [execute](XHTML.md#execute)
- [getDOMObject](XHTML.md#getdomobject)
- [getHTML](XHTML.md#gethtml)
- [hide](XHTML.md#hide)
- [init](XHTML.md#init)
- [log](XHTML.md#log)
- [mount](XHTML.md#mount)
- [onCreate](XHTML.md#oncreate)
- [onData](XHTML.md#ondata)
- [onFrame](XHTML.md#onframe)
- [onHide](XHTML.md#onhide)
- [onMount](XHTML.md#onmount)
- [onShow](XHTML.md#onshow)
- [parse](XHTML.md#parse)
- [parseEvents](XHTML.md#parseevents)
- [parseFields](XHTML.md#parsefields)
- [parseFieldsFromXDataObject](XHTML.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XHTML.md#removealleventlisteners)
- [removeChild](XHTML.md#removechild)
- [removeClass](XHTML.md#removeclass)
- [removeEventListener](XHTML.md#removeeventlistener)
- [replaceClass](XHTML.md#replaceclass)
- [run](XHTML.md#run)
- [setStyleAttribute](XHTML.md#setstyleattribute)
- [setText](XHTML.md#settext)
- [show](XHTML.md#show)
- [stopAnimation](XHTML.md#stopanimation)
- [toString](XHTML.md#tostring)
- [toXData](XHTML.md#toxdata)
- [toggle](XHTML.md#toggle)
- [toggleClass](XHTML.md#toggleclass)

## Constructors

### constructor

• **new XHTML**(`data`): [`XHTML`](XHTML.md)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:308](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L308)
...
▪ `Static` **\_xtype**: `string` = `"xhtml"`

#### Defined in

[web/xpell-ui/src/XUI/XUICoreObjects.ts:307](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L307)
