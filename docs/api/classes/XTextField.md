[xpell-ui - v2.0.0-alpha.1](../README.md) / XTextField
...
- [constructor](XTextField.md#constructor)

### Properties

- [\_base\_display](XTextField.md#_base_display)
- [\_cache\_cmd\_txt](XTextField.md#_cache_cmd_txt)
- [\_cache\_jcmd](XTextField.md#_cache_jcmd)
- [\_children](XTextField.md#_children)
- [\_data\_source](XTextField.md#_data_source)
- [\_debug](XTextField.md#_debug)
- [\_dom\_object](XTextField.md#_dom_object)
- [\_event\_listeners\_ids](XTextField.md#_event_listeners_ids)
- [\_html](XTextField.md#_html)
- [\_html\_ns](XTextField.md#_html_ns)
- [\_html\_tag](XTextField.md#_html_tag)
- [\_id](XTextField.md#_id)
- [\_name](XTextField.md#_name)
- [\_nano\_commands](XTextField.md#_nano_commands)
- [\_on](XTextField.md#_on)
- [\_on\_click](XTextField.md#_on_click)
- [\_on\_create](XTextField.md#_on_create)
- [\_on\_data](XTextField.md#_on_data)
- [\_on\_event](XTextField.md#_on_event)
- [\_on\_frame](XTextField.md#_on_frame)
- [\_on\_hide](XTextField.md#_on_hide)
- [\_on\_hide\_animation](XTextField.md#_on_hide_animation)
- [\_on\_mount](XTextField.md#_on_mount)
- [\_on\_show](XTextField.md#_on_show)
- [\_on\_show\_animation](XTextField.md#_on_show_animation)
- [\_once](XTextField.md#_once)
- [\_parent](XTextField.md#_parent)
- [\_parent\_element](XTextField.md#_parent_element)
- [\_process\_data](XTextField.md#_process_data)
- [\_process\_frame](XTextField.md#_process_frame)
- [\_type](XTextField.md#_type)
- [\_visible](XTextField.md#_visible)
- [\_xem\_options](XTextField.md#_xem_options)
- [\_xporter](XTextField.md#_xporter)
- [\_xtype](XTextField.md#_xtype)
- [type](XTextField.md#type)

### Accessors

- [\_text](XTextField.md#_text)
- [dom](XTextField.md#dom)

### Methods

- [addChild](XTextField.md#addchild)
- [addClass](XTextField.md#addclass)
- [addEventListener](XTextField.md#addeventlistener)
- [addNanoCommand](XTextField.md#addnanocommand)
- [addNanoCommandPack](XTextField.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XTextField.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XTextField.md#addxporterinstancexporter)
- [animate](XTextField.md#animate)
- [append](XTextField.md#append)
- [attach](XTextField.md#attach)
- [checkAndRunInternalFunction](XTextField.md#checkandruninternalfunction)
- [clearAttributes](XTextField.md#clearattributes)
- [click](XTextField.md#click)
- [dispose](XTextField.md#dispose)
- [emptyDataSource](XTextField.md#emptydatasource)
- [execute](XTextField.md#execute)
- [getDOMObject](XTextField.md#getdomobject)
- [getHTML](XTextField.md#gethtml)
- [hide](XTextField.md#hide)
- [init](XTextField.md#init)
- [log](XTextField.md#log)
- [mount](XTextField.md#mount)
- [onCreate](XTextField.md#oncreate)
- [onData](XTextField.md#ondata)
- [onFrame](XTextField.md#onframe)
- [onHide](XTextField.md#onhide)
- [onMount](XTextField.md#onmount)
- [onShow](XTextField.md#onshow)
- [parse](XTextField.md#parse)
- [parseEvents](XTextField.md#parseevents)
- [parseFields](XTextField.md#parsefields)
- [parseFieldsFromXDataObject](XTextField.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XTextField.md#removealleventlisteners)
- [removeChild](XTextField.md#removechild)
- [removeClass](XTextField.md#removeclass)
- [removeEventListener](XTextField.md#removeeventlistener)
- [replaceClass](XTextField.md#replaceclass)
- [run](XTextField.md#run)
- [setStyleAttribute](XTextField.md#setstyleattribute)
- [setText](XTextField.md#settext)
- [show](XTextField.md#show)
- [stopAnimation](XTextField.md#stopanimation)
- [toString](XTextField.md#tostring)
- [toXData](XTextField.md#toxdata)
- [toggle](XTextField.md#toggle)
- [toggleClass](XTextField.md#toggleclass)

## Constructors

### constructor

• **new XTextField**(`data`): [`XTextField`](XTextField.md)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:166](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L166)
...
▪ `Static` **\_xtype**: `string` = `"text"`

#### Defined in

[web/xpell-ui/src/XUI/XUICoreObjects.ts:164](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L164)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:165](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L165)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:179](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L179)
