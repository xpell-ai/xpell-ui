[xpell-ui - v2.0.0-alpha.1](../README.md) / XButton
...
- [constructor](XButton.md#constructor)

### Properties

- [\_base\_display](XButton.md#_base_display)
- [\_cache\_cmd\_txt](XButton.md#_cache_cmd_txt)
- [\_cache\_jcmd](XButton.md#_cache_jcmd)
- [\_children](XButton.md#_children)
- [\_data\_source](XButton.md#_data_source)
- [\_debug](XButton.md#_debug)
- [\_dom\_object](XButton.md#_dom_object)
- [\_event\_listeners\_ids](XButton.md#_event_listeners_ids)
- [\_html](XButton.md#_html)
- [\_html\_ns](XButton.md#_html_ns)
- [\_html\_tag](XButton.md#_html_tag)
- [\_id](XButton.md#_id)
- [\_name](XButton.md#_name)
- [\_nano\_commands](XButton.md#_nano_commands)
- [\_on](XButton.md#_on)
- [\_on\_click](XButton.md#_on_click)
- [\_on\_create](XButton.md#_on_create)
- [\_on\_data](XButton.md#_on_data)
- [\_on\_event](XButton.md#_on_event)
- [\_on\_frame](XButton.md#_on_frame)
- [\_on\_hide](XButton.md#_on_hide)
- [\_on\_hide\_animation](XButton.md#_on_hide_animation)
- [\_on\_mount](XButton.md#_on_mount)
- [\_on\_show](XButton.md#_on_show)
- [\_on\_show\_animation](XButton.md#_on_show_animation)
- [\_once](XButton.md#_once)
- [\_parent](XButton.md#_parent)
- [\_parent\_element](XButton.md#_parent_element)
- [\_process\_data](XButton.md#_process_data)
- [\_process\_frame](XButton.md#_process_frame)
- [\_type](XButton.md#_type)
- [\_visible](XButton.md#_visible)
- [\_xem\_options](XButton.md#_xem_options)
- [\_xporter](XButton.md#_xporter)
- [\_xtype](XButton.md#_xtype)

### Accessors

- [\_text](XButton.md#_text)
- [dom](XButton.md#dom)

### Methods

- [addChild](XButton.md#addchild)
- [addClass](XButton.md#addclass)
- [addEventListener](XButton.md#addeventlistener)
- [addNanoCommand](XButton.md#addnanocommand)
- [addNanoCommandPack](XButton.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XButton.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XButton.md#addxporterinstancexporter)
- [animate](XButton.md#animate)
- [append](XButton.md#append)
- [attach](XButton.md#attach)
- [checkAndRunInternalFunction](XButton.md#checkandruninternalfunction)
- [clearAttributes](XButton.md#clearattributes)
- [click](XButton.md#click)
- [dispose](XButton.md#dispose)
- [emptyDataSource](XButton.md#emptydatasource)
- [execute](XButton.md#execute)
- [getDOMObject](XButton.md#getdomobject)
- [getHTML](XButton.md#gethtml)
- [hide](XButton.md#hide)
- [init](XButton.md#init)
- [log](XButton.md#log)
- [mount](XButton.md#mount)
- [onCreate](XButton.md#oncreate)
- [onData](XButton.md#ondata)
- [onFrame](XButton.md#onframe)
- [onHide](XButton.md#onhide)
- [onMount](XButton.md#onmount)
- [onShow](XButton.md#onshow)
- [parse](XButton.md#parse)
- [parseEvents](XButton.md#parseevents)
- [parseFields](XButton.md#parsefields)
- [parseFieldsFromXDataObject](XButton.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XButton.md#removealleventlisteners)
- [removeChild](XButton.md#removechild)
- [removeClass](XButton.md#removeclass)
- [removeEventListener](XButton.md#removeeventlistener)
- [replaceClass](XButton.md#replaceclass)
- [run](XButton.md#run)
- [setOnclick](XButton.md#setonclick)
- [setStyleAttribute](XButton.md#setstyleattribute)
- [setText](XButton.md#settext)
- [show](XButton.md#show)
- [stopAnimation](XButton.md#stopanimation)
- [toString](XButton.md#tostring)
- [toXData](XButton.md#toxdata)
- [toggle](XButton.md#toggle)
- [toggleClass](XButton.md#toggleclass)

## Constructors

### constructor

• **new XButton**(`data`): [`XButton`](XButton.md)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:326](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L326)
...
▪ `Static` **\_xtype**: `string` = `"button"`

#### Defined in

[web/xpell-ui/src/XUI/XUICoreObjects.ts:324](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L324)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:335](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L335)
