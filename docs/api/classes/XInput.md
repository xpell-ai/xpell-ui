[xpell-ui - v2.0.0-alpha.1](../README.md) / XInput
...
- [constructor](XInput.md#constructor)

### Properties

- [\_base\_display](XInput.md#_base_display)
- [\_cache\_cmd\_txt](XInput.md#_cache_cmd_txt)
- [\_cache\_jcmd](XInput.md#_cache_jcmd)
- [\_children](XInput.md#_children)
- [\_data\_source](XInput.md#_data_source)
- [\_debug](XInput.md#_debug)
- [\_dom\_object](XInput.md#_dom_object)
- [\_event\_listeners\_ids](XInput.md#_event_listeners_ids)
- [\_html](XInput.md#_html)
- [\_html\_ns](XInput.md#_html_ns)
- [\_html\_tag](XInput.md#_html_tag)
- [\_id](XInput.md#_id)
- [\_name](XInput.md#_name)
- [\_nano\_commands](XInput.md#_nano_commands)
- [\_on](XInput.md#_on)
- [\_on\_click](XInput.md#_on_click)
- [\_on\_create](XInput.md#_on_create)
- [\_on\_data](XInput.md#_on_data)
- [\_on\_event](XInput.md#_on_event)
- [\_on\_frame](XInput.md#_on_frame)
- [\_on\_hide](XInput.md#_on_hide)
- [\_on\_hide\_animation](XInput.md#_on_hide_animation)
- [\_on\_mount](XInput.md#_on_mount)
- [\_on\_show](XInput.md#_on_show)
- [\_on\_show\_animation](XInput.md#_on_show_animation)
- [\_once](XInput.md#_once)
- [\_parent](XInput.md#_parent)
- [\_parent\_element](XInput.md#_parent_element)
- [\_process\_data](XInput.md#_process_data)
- [\_process\_frame](XInput.md#_process_frame)
- [\_type](XInput.md#_type)
- [\_visible](XInput.md#_visible)
- [\_xem\_options](XInput.md#_xem_options)
- [\_xporter](XInput.md#_xporter)
- [\_xtype](XInput.md#_xtype)
- [type](XInput.md#type)

### Accessors

- [\_input\_type](XInput.md#_input_type)
- [\_text](XInput.md#_text)
- [dom](XInput.md#dom)

### Methods

- [addChild](XInput.md#addchild)
- [addClass](XInput.md#addclass)
- [addEventListener](XInput.md#addeventlistener)
- [addNanoCommand](XInput.md#addnanocommand)
- [addNanoCommandPack](XInput.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XInput.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XInput.md#addxporterinstancexporter)
- [animate](XInput.md#animate)
- [append](XInput.md#append)
- [attach](XInput.md#attach)
- [checkAndRunInternalFunction](XInput.md#checkandruninternalfunction)
- [clearAttributes](XInput.md#clearattributes)
- [click](XInput.md#click)
- [dispose](XInput.md#dispose)
- [emptyDataSource](XInput.md#emptydatasource)
- [execute](XInput.md#execute)
- [getDOMObject](XInput.md#getdomobject)
- [getHTML](XInput.md#gethtml)
- [hide](XInput.md#hide)
- [init](XInput.md#init)
- [log](XInput.md#log)
- [mount](XInput.md#mount)
- [onCreate](XInput.md#oncreate)
- [onData](XInput.md#ondata)
- [onFrame](XInput.md#onframe)
- [onHide](XInput.md#onhide)
- [onMount](XInput.md#onmount)
- [onShow](XInput.md#onshow)
- [parse](XInput.md#parse)
- [parseEvents](XInput.md#parseevents)
- [parseFields](XInput.md#parsefields)
- [parseFieldsFromXDataObject](XInput.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XInput.md#removealleventlisteners)
- [removeChild](XInput.md#removechild)
- [removeClass](XInput.md#removeclass)
- [removeEventListener](XInput.md#removeeventlistener)
- [replaceClass](XInput.md#replaceclass)
- [run](XInput.md#run)
- [setStyleAttribute](XInput.md#setstyleattribute)
- [setText](XInput.md#settext)
- [show](XInput.md#show)
- [stopAnimation](XInput.md#stopanimation)
- [toString](XInput.md#tostring)
- [toXData](XInput.md#toxdata)
- [toggle](XInput.md#toggle)
- [toggleClass](XInput.md#toggleclass)

## Constructors

### constructor

• **new XInput**(`data`): [`XInput`](XInput.md)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:219](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L219)
...
▪ `Static` **\_xtype**: `string` = `"input"`

#### Defined in

[web/xpell-ui/src/XUI/XUICoreObjects.ts:217](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L217)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:218](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L218)

## Accessors

### \_input\_type

• `get` **_input_type**(): `string`
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:249](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L249)

• `set` **_input_type**(`type`): `void`
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:242](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L242)
...
[web/xpell-ui/src/XUI/XUICoreObjects.ts:235](https://github.com/AimeVerse/xpell-ui/blob/7369fefd7ffa5ca685b1214ce3f7d159e24d01fc/src/XUI/XUICoreObjects.ts#L235)
